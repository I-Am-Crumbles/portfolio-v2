...
![lab1](../../../assets/images/portswigger/sqli/union/union01.png)
...
![Accessories](../../../assets/images/portswigger/sqli/union/union02.png)

![Request](../../../assets/images/portswigger/sqli/union/union03.png)
...
![error](../../../assets/images/portswigger/sqli/union/union04.png)

The payload continues to generate an error until it's modified to contain three *NULL* values in the parameter. 

![NULL NULL NULL](../../../assets/images/portswigger/sqli/union/union05.png)
...
![order by 1](../../../assets/images/portswigger/sqli/union/union06.png)

![order by 2](../../../assets/images/portswigger/sqli/union/union07.png)

![order by 3](../../../assets/images/portswigger/sqli/union/union08.png)

![order by 4](../../../assets/images/portswigger/sqli/union/union09.png)

Lab 1 was completed during the testing when I sent the `'+UNION+SELECT+NULL,NULL,NULL--` payload.

![finish](../../../assets/images/portswigger/sqli/union/union10.png)
...
![lab2](../../../assets/images/portswigger/sqli/union/union11.png)
...
![string value](../../../assets/images/portswigger/sqli/union/union12.png)
...
![request](../../../assets/images/portswigger/sqli/union/union13.png)

![solved](../../../assets/images/portswigger/sqli/union/union14.png)
...
![lab3](../../../assets/images/portswigger/sqli/union/union15.png)
...
![payload](../../../assets/images/portswigger/sqli/union/union16.png)

Using that account information to log in solves the challenge. 

![solved](../../../assets/images/portswigger/sqli/union/union17.png)
...
![lab4](../../../assets/images/portswigger/sqli/union/union18.png)
...
![request](../../../assets/images/portswigger/sqli/union/union19.png)
...
![payload](../../../assets/images/portswigger/sqli/union/union20.png)
