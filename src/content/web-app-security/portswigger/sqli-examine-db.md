---
title: "SQLi Examining The Database"
date: 2023-08-10
section: portswigger
---
...
![lab1](../../../assets/images/portswigger/sqli/examinedb/examinedb01.png)

![request](../../../assets/images/portswigger/sqli/examinedb/examinedb02.png)
...
![number of columns](../../../assets/images/portswigger/sqli/examinedb/examinedb03.png)
...
![Select Banner](../../../assets/images/portswigger/sqli/examinedb/examinedb04.png)
...
![response](../../../assets/images/portswigger/sqli/examinedb/examinedb05.png)

Triggering that response from the web application solves the challenge. 

![solved](../../../assets/images/portswigger/sqli/examinedb/examinedb06.png)

---

*SQL Injection Attack, Querying The Database Type And Version On MySQL and Microsoft* 

![lab2](../../../assets/images/portswigger/sqli/examinedb/examinedb07.png)
...
![2 columns](../../../assets/images/portswigger/sqli/examinedb/examinedb08.png)
...
![request](../../../assets/images/portswigger/sqli/examinedb/examinedb09.png)
...
![response](../../../assets/images/portswigger/sqli/examinedb/examinedb10.png)

![solved2](../../../assets/images/portswigger/sqli/examinedb/examinedb11.png)

---

*SQL Injection Attack, Listing The Database Contents On Non-Oracle Databases* 

![lab3](../../../assets/images/portswigger/sqli/examinedb/examinedb12.png)
...
![Pets Request](../../../assets/images/portswigger/sqli/examinedb/examinedb13.png)
...
![information schema tables](../../../assets/images/portswigger/sqli/examinedb/examinedb14.png)

This query returns many, many tables in the response.  

![tables1](../../../assets/images/portswigger/sqli/examinedb/examinedb15.png)

![tables2](../../../assets/images/portswigger/sqli/examinedb/examinedb16.png)

![tables3](../../../assets/images/portswigger/sqli/examinedb/examinedb17.png)

Within those results is a table called `users_gbcwql` which likely contains data on all the user credentials. 

![users table](../../../assets/images/portswigger/sqli/examinedb/examinedb18.png)
...
![column names](../../../assets/images/portswigger/sqli/examinedb/examinedb19.png)
...
![admin creds](../../../assets/images/portswigger/sqli/examinedb/examinedb20.png)

logging in with the credentials `administrator:i7i0f48ss6jyd28mb5j7` completes the challenge 

![solved3](../../../assets/images/portswigger/sqli/examinedb/examinedb21.png)

---

*SQL Injection Attack, Listing The Database Contents On Oracle* 

![lab3](../../../assets/images/portswigger/sqli/examinedb/examinedb22.png)
...
![column number query](../../../assets/images/portswigger/sqli/examinedb/examinedb23.png)

![column number response](../../../assets/images/portswigger/sqli/examinedb/examinedb24.png)
...
![many tables](../../../assets/images/portswigger/sqli/examinedb/examinedb25.png)

The one I'm looking for is the `USERS_OERPCY` table. 

![users table](../../../assets/images/portswigger/sqli/examinedb/examinedb26.png)
...
![column names](../../../assets/images/portswigger/sqli/examinedb/examinedb27.png)
...
![admin creds](../../../assets/images/portswigger/sqli/examinedb/examinedb28.png)

Logging in with the found credentials solves the challenge for this lab. 

![solved4](../../../assets/images/portswigger/sqli/examinedb/examinedb29.png)
