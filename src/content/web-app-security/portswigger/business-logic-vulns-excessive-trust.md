---
title: "Business Logic Vulnerabilities; Excessive Trust"
date: 2023-09-10
section: portswigger
---
...
![lab1 intro](../../../assets/images/portswigger/businesslogicvulns/excessivetrust/blv01.png)
...
![view details](../../../assets/images/portswigger/businesslogicvulns/excessivetrust/blv02.png)

![cart](../../../assets/images/portswigger/businesslogicvulns/excessivetrust/blv03.png)

![cart request](../../../assets/images/portswigger/businesslogicvulns/excessivetrust/blv04.png)
...
![total $1](../../../assets/images/portswigger/businesslogicvulns/excessivetrust/blv05.png)

![lab1 solved](../../../assets/images/portswigger/businesslogicvulns/excessivetrust/blv06.png)
...
![lab1 solved](../../../assets/images/portswigger/businesslogicvulns/excessivetrust/blv07.png)
...
![lab2 intro](../../../assets/images/portswigger/businesslogicvulns/excessivetrust/blv08.png)

I'll start this lab off by logging in with the provided credentials and I can see that I again have $100 of store credit.  

![login wiener](../../../assets/images/portswigger/businesslogicvulns/excessivetrust/blv09.png)

From there I'll navigate to the `l33t Leather Jacket` product page and add one to my cart. 

![add to cart](../../../assets/images/portswigger/businesslogicvulns/excessivetrust/blv10.png)
...
![cart post request](../../../assets/images/portswigger/businesslogicvulns/excessivetrust/blv11.png)
...
![second item to cart](../../../assets/images/portswigger/businesslogicvulns/excessivetrust/blv12.png)

![second item repeater](../../../assets/images/portswigger/businesslogicvulns/excessivetrust/blv13.png)
...
![forward repeater](../../../assets/images/portswigger/businesslogicvulns/excessivetrust/blv14.png)

![updated cart](../../../assets/images/portswigger/businesslogicvulns/excessivetrust/blv15.png)
...
![repeater](../../../assets/images/portswigger/businesslogicvulns/excessivetrust/blv16.png)

![cheaper cart](../../../assets/images/portswigger/businesslogicvulns/excessivetrust/blv17.png)
...
![request](../../../assets/images/portswigger/businesslogicvulns/excessivetrust/blv18.png)

![updated cart again](../../../assets/images/portswigger/businesslogicvulns/excessivetrust/blv19.png)
...
![cart error](../../../assets/images/portswigger/businesslogicvulns/excessivetrust/blv20.png)

A quantity of `-64` will result in the cart having a total of `$50.60` which is cheap enough to purchase with my store credit.  

![cart in range](../../../assets/images/portswigger/businesslogicvulns/excessivetrust/blv21.png)

Placing the order marks the lab as solved. 

![lab2 solved](../../../assets/images/portswigger/businesslogicvulns/excessivetrust/blv22.png)

---

*Low Level Logic Flaw* 

![lab3 intro](../../../assets/images/portswigger/businesslogicvulns/excessivetrust/blv24.png)
...
![login](../../../assets/images/portswigger/businesslogicvulns/excessivetrust/blv25.png)

![my account](../../../assets/images/portswigger/businesslogicvulns/excessivetrust/blv26.png)
...
![ladd to cart](../../../assets/images/portswigger/businesslogicvulns/excessivetrust/blv27.png)

![cart](../../../assets/images/portswigger/businesslogicvulns/excessivetrust/blv28.png)

![post to cart](../../../assets/images/portswigger/businesslogicvulns/excessivetrust/blv29.png)

The only parameter that has a value that can be manipulated is the `quantity` parameter in this POST request to `/cart`.  

![quantity](../../../assets/images/portswigger/businesslogicvulns/excessivetrust/blv30.png)

It can also be observed that the web application filters out quantities greater than 2 digits. 

![can only edit 2 digits](../../../assets/images/portswigger/businesslogicvulns/excessivetrust/blv31.png)
...
![forward 99](../../../assets/images/portswigger/businesslogicvulns/excessivetrust/blv32.png)

![cart has 100](../../../assets/images/portswigger/businesslogicvulns/excessivetrust/blv33.png)
...
![no position markers](../../../assets/images/portswigger/businesslogicvulns/excessivetrust/blv34.png)
...
![payload settings](../../../assets/images/portswigger/businesslogicvulns/excessivetrust/blv35.png)
...
![large negative number](../../../assets/images/portswigger/businesslogicvulns/excessivetrust/blv36.png)
...
![clear cart](../../../assets/images/portswigger/businesslogicvulns/excessivetrust/blv37.png)
...
![323 payloads](../../../assets/images/portswigger/businesslogicvulns/excessivetrust/blv38.png)

![resource pool](../../../assets/images/portswigger/businesslogicvulns/excessivetrust/blv39.png)
...
![still too expensive](../../../assets/images/portswigger/businesslogicvulns/excessivetrust/blv40.png)
...
![back to repeater](../../../assets/images/portswigger/businesslogicvulns/excessivetrust/blv41.png)

![cart within one jacket](../../../assets/images/portswigger/businesslogicvulns/excessivetrust/blv42.png)
...
![pools](../../../assets/images/portswigger/businesslogicvulns/excessivetrust/blv43.png)

![add 14](../../../assets/images/portswigger/businesslogicvulns/excessivetrust/blv44.png)

![cart purchasable now](../../../assets/images/portswigger/businesslogicvulns/excessivetrust/blv45.png)
...
![lab3 solved](../../../assets/images/portswigger/businesslogicvulns/excessivetrust/blv46.png)

---

*Inconsistent Handling of Exceptional Input* 

![lab4 intro](../../../assets/images/portswigger/businesslogicvulns/excessivetrust/blv47.png)
...
![discover content](../../../assets/images/portswigger/businesslogicvulns/excessivetrust/blv48.png)

A new window will pop up and I simply click the *Session is not running* button to start the scan. 

![content scan](../../../assets/images/portswigger/businesslogicvulns/excessivetrust/blv49.png)
...
![sitemap](../../../assets/images/portswigger/businesslogicvulns/excessivetrust/blv50.png)
...
![don't wanna cry only](../../../assets/images/portswigger/businesslogicvulns/excessivetrust/blv51.png)
...
![email client](../../../assets/images/portswigger/businesslogicvulns/excessivetrust/blv52.png)
...
![register](../../../assets/images/portswigger/businesslogicvulns/excessivetrust/blv53.png)

I received an email in the client with a registration link. 

![email link](../../../assets/images/portswigger/businesslogicvulns/excessivetrust/blv54.png)
...
![account registered](../../../assets/images/portswigger/businesslogicvulns/excessivetrust/blv55.png)
...
![register form](../../../assets/images/portswigger/businesslogicvulns/excessivetrust/blv56.png)

![new email link](../../../assets/images/portswigger/businesslogicvulns/excessivetrust/blv57.png)

Now that I've registered my new user I can login and see that I now have access to the *Admin Panel* 

![admin panel](../../../assets/images/portswigger/businesslogicvulns/excessivetrust/blv58.png)
...
![delete carlos](../../../assets/images/portswigger/businesslogicvulns/excessivetrust/blv59.png)

![lab4 solved](../../../assets/images/portswigger/businesslogicvulns/excessivetrust/blv60.png)
