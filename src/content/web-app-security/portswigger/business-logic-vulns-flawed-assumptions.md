---
title: "Business Logic Vulnerabilities; Flawed Assumptions"
date: 2023-09-11
section: portswigger
---
...
![lab1 intro](../../../assets/images/portswigger/businesslogicvulns/flawedassumptions/flawed01.png)

![lab page](../../../assets/images/portswigger/businesslogicvulns/flawedassumptions/flawed02.png)
...
![discover content](../../../assets/images/portswigger/businesslogicvulns/flawedassumptions/flawed03.png)
...
![admin found](../../../assets/images/portswigger/businesslogicvulns/flawedassumptions/flawed04.png)

![dont wanna cry users only](../../../assets/images/portswigger/businesslogicvulns/flawedassumptions/flawed05.png)
...
![email client](../../../assets/images/portswigger/businesslogicvulns/flawedassumptions/flawed06.png)
...
![register](../../../assets/images/portswigger/businesslogicvulns/flawedassumptions/flawed07.png)
...
![email registration link](../../../assets/images/portswigger/businesslogicvulns/flawedassumptions/flawed08.png)

![registration successful](../../../assets/images/portswigger/businesslogicvulns/flawedassumptions/flawed09.png)
...
![update email](../../../assets/images/portswigger/businesslogicvulns/flawedassumptions/flawed10.png)

Since the application now reads my email as having a `@dontwannacry.com` address the *Admin panel* is now accessible. 

![admin panel](../../../assets/images/portswigger/businesslogicvulns/flawedassumptions/flawed11.png)

Inside the admin panel all I have to do is delete user *carlos* and the lab is complete. 

![delete carlos](../../../assets/images/portswigger/businesslogicvulns/flawedassumptions/flawed12.png)

![lab1 solved](../../../assets/images/portswigger/businesslogicvulns/flawedassumptions/flawed13.png)

---

*Weak Isolation On Dual-Use Endpoint* 

![lab2 intro](../../../assets/images/portswigger/businesslogicvulns/flawedassumptions/flawed14.png)

To start off this lab I login with the provided credentials *wiener:peter*. 

![login](../../../assets/images/portswigger/businesslogicvulns/flawedassumptions/flawed15.png)

![my account](../../../assets/images/portswigger/businesslogicvulns/flawedassumptions/flawed16.png)

On the *My Account* page I have the option to edit my *Email*, *Username*, *Current password* and two *New password* fields. 

![update fields](../../../assets/images/portswigger/businesslogicvulns/flawedassumptions/flawed17.png)
...
![password incorrect](../../../assets/images/portswigger/businesslogicvulns/flawedassumptions/flawed18.png)
...
![update account request](../../../assets/images/portswigger/businesslogicvulns/flawedassumptions/flawed19.png)
...
![no error message](../../../assets/images/portswigger/businesslogicvulns/flawedassumptions/flawed20.png)
...
![login admin](../../../assets/images/portswigger/businesslogicvulns/flawedassumptions/flawed21.png)

Now I just need to navigate to the *Admin panel* and delete user *carlos* to complete the lab. 

![delete carlos](../../../assets/images/portswigger/businesslogicvulns/flawedassumptions/flawed22.png)

![lab2 solved](../../../assets/images/portswigger/businesslogicvulns/flawedassumptions/flawed23.png)

---

*Insufficient Workflow Validation* 

![lab3 intro](../../../assets/images/portswigger/businesslogicvulns/flawedassumptions/flawed24.png)
...
![login](../../../assets/images/portswigger/businesslogicvulns/flawedassumptions/flawed25.png)
...
![potato theater](../../../assets/images/portswigger/businesslogicvulns/flawedassumptions/flawed26.png)

![cart](../../../assets/images/portswigger/businesslogicvulns/flawedassumptions/flawed27.png)
...
![get confirm true](../../../assets/images/portswigger/businesslogicvulns/flawedassumptions/flawed28.png)
...
![add jacket to car](../../../assets/images/portswigger/businesslogicvulns/flawedassumptions/flawed29.png)
...
![forward request](../../../assets/images/portswigger/businesslogicvulns/flawedassumptions/flawed30.png)
...
![lab3 solved](../../../assets/images/portswigger/businesslogicvulns/flawedassumptions/flawed31.png)

---

*Authentication Bypass Via Flawed State Machine* 

![lab4 intro](../../../assets/images/portswigger/businesslogicvulns/flawedassumptions/flawed32.png)

Upon logging in with the provided credentials the application immediately sends me to a page where I must select a role. 

![select a role](../../../assets/images/portswigger/businesslogicvulns/flawedassumptions/flawed33.png)

I tried to intercept the *Post* request and edit the role to administrator but that didn't work. 

![post request](../../../assets/images/portswigger/businesslogicvulns/flawedassumptions/flawed34.png)
...
![drop request](../../../assets/images/portswigger/businesslogicvulns/flawedassumptions/flawed35.png)

![error](../../../assets/images/portswigger/businesslogicvulns/flawedassumptions/flawed36.png)
...
![admin panel now accessible](../../../assets/images/portswigger/businesslogicvulns/flawedassumptions/flawed37.png)

From there I just need to navigate over to the *Admin Panel* and delete user *carlos*. This solves the challenge for this lab. 

![delete carlos](../../../assets/images/portswigger/businesslogicvulns/flawedassumptions/flawed38.png)

![lab4 solved](../../../assets/images/portswigger/businesslogicvulns/flawedassumptions/flawed39.png)
