---
title: "Authentication: Vulnerabilities In Multi-Factor Authentication"
date: 2023-08-20
section: portswigger
---
...
![lab1](../../../assets/images/portswigger/authentication/2fa/2fa01.png)
...
![login](../../../assets/images/portswigger/authentication/2fa/2fa02.png)

![email server](../../../assets/images/portswigger/authentication/2fa/2fa03.png)

![entercode](../../../assets/images/portswigger/authentication/2fa/2fa04.png)
...
![page url](../../../assets/images/portswigger/authentication/2fa/2fa05.png)

![my account request](../../../assets/images/portswigger/authentication/2fa/2fa06.png)
...
![login carlos](../../../assets/images/portswigger/authentication/2fa/2fa07.png)

![carlos request](../../../assets/images/portswigger/authentication/2fa/2fa08.png)
...
![edit request](../../../assets/images/portswigger/authentication/2fa/2fa09.png)

![solved](../../../assets/images/portswigger/authentication/2fa/2fa10.png)

---

*2FA Broken Logic*

![lab2](../../../assets/images/portswigger/authentication/2fa/2fa11.png)
...
![login](../../../assets/images/portswigger/authentication/2fa/2fa12.png)

![email client](../../../assets/images/portswigger/authentication/2fa/2fa13.png)

![code](../../../assets/images/portswigger/authentication/2fa/2fa14.png)
...
![get login2](../../../assets/images/portswigger/authentication/2fa/2fa15.png)

![verify=carlos](../../../assets/images/portswigger/authentication/2fa/2fa16.png)
...
![fake code](../../../assets/images/portswigger/authentication/2fa/2fa17.png)

![post login2](../../../assets/images/portswigger/authentication/2fa/2fa18.png)
...
![intruder](../../../assets/images/portswigger/authentication/2fa/2fa19.png)
...
![payload set 1](../../../assets/images/portswigger/authentication/2fa/2fa20.png)
...
![0784](../../../assets/images/portswigger/authentication/2fa/2fa21.png)
...
![show in browser](../../../assets/images/portswigger/authentication/2fa/2fa22.png)

![url](../../../assets/images/portswigger/authentication/2fa/2fa23.png)
...
![solved2](../../../assets/images/portswigger/authentication/2fa/2fa24.png)

---

*2FA Bypass Using A Brute-Force Attack*

![lab3](../../../assets/images/portswigger/authentication/2fa/2fa25.png)
...
![login](../../../assets/images/portswigger/authentication/2fa/2fa26.png)

![enter code](../../../assets/images/portswigger/authentication/2fa/2fa27.png)
...
![2 POST to login2](../../../assets/images/portswigger/authentication/2fa/2fa28.png)

![Incorrect security code login](../../../assets/images/portswigger/authentication/2fa/2fa29.png)
...
![settings](../../../assets/images/portswigger/authentication/2fa/2fa30.png)

![project sessions](../../../assets/images/portswigger/authentication/2fa/2fa31.png)
...
![macro requests](../../../assets/images/portswigger/authentication/2fa/2fa32.png)
...
![test macro](../../../assets/images/portswigger/authentication/2fa/2fa33.png)

![verify response codes](../../../assets/images/portswigger/authentication/2fa/2fa34.png)
...
![session handling rules](../../../assets/images/portswigger/authentication/2fa/2fa35.png)
...
![select macro to run](../../../assets/images/portswigger/authentication/2fa/2fa36.png)
...
![include all urls](../../../assets/images/portswigger/authentication/2fa/2fa37.png)

With the macro set up I need to select a valid *POST* request to the */login2* sub directory and send it to the *Intruder*.  

![send to intruder](../../../assets/images/portswigger/authentication/2fa/2fa38.png)
...
![payload position](../../../assets/images/portswigger/authentication/2fa/2fa39.png)
...
![payload set](../../../assets/images/portswigger/authentication/2fa/2fa40.png)
...
![resource pool](../../../assets/images/portswigger/authentication/2fa/2fa41.png)
...
![failed](../../../assets/images/portswigger/authentication/2fa/2fa42.png)
...
![302 response](../../../assets/images/portswigger/authentication/2fa/2fa43.png)
...
![solved](../../../assets/images/portswigger/authentication/2fa/2fa44.png)
