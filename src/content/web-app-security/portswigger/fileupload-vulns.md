...
![lab1 intro](../../../assets/images/portswigger/fileupload/fu01.png)
...
![lab1 login](../../../assets/images/portswigger/fileupload/fu02.png)
...
![upload test avatar](../../../assets/images/portswigger/fileupload/fu03.png)

I can also observe in Burp this functionality is achieved with a `POST` request to `/my-account/avatar`. 

![post /my-account/avatar](../../../assets/images/portswigger/fileupload/fu04.png)
...
![get files/avatars/image](../../../assets/images/portswigger/fileupload/fu05.png)

![avatar on profile](../../../assets/images/portswigger/fileupload/fu06.png)
...
![vim testploit.php](../../../assets/images/portswigger/fileupload/fu07.png)

Now I upload the file to the server and see it allows me to upload whatever file type I want. 

![upload testploit](../../../assets/images/portswigger/fileupload/fu08.png)

![allowed](../../../assets/images/portswigger/fileupload/fu09.png)
...
![edit repeater](../../../assets/images/portswigger/fileupload/fu10.png)

To solve the lab I just submit that string back in the web browser. 

![submit string](../../../assets/images/portswigger/fileupload/fu11.png)

![lab1 solved](../../../assets/images/portswigger/fileupload/fu12.png)

---

*Web Shell Upload Via Content-Type Restriction Bypass* 

![lab2 intro](../../../assets/images/portswigger/fileupload/fu13.png)
...
![lab2 login](../../../assets/images/portswigger/fileupload/fu14.png)

![file type not allowed](../../../assets/images/portswigger/fileupload/fu15.png)
...
![my account avatar to repeater](../../../assets/images/portswigger/fileupload/fu16.png)
...
![edit content type](../../../assets/images/portswigger/fileupload/fu17.png)
...
![see png in request](../../../assets/images/portswigger/fileupload/fu18.png)

![change in repeater and get secret](../../../assets/images/portswigger/fileupload/fu19.png)
...
![submit secret](../../../assets/images/portswigger/fileupload/fu20.png)

![lab2 solved](../../../assets/images/portswigger/fileupload/fu21.png)

---

*Web Shell Upload Via Path Traversal* 

![lab3 intro](../../../assets/images/portswigger/fileupload/fu22.png)

To start this lab off I logged in with the credentials `wiener:peter` and upload my `testploit.php` file. 

![lab3 login](../../../assets/images/portswigger/fileupload/fu23.png)

![lab3 upload php file](../../../assets/images/portswigger/fileupload/fu24.png)
...
![response just mirrors file contents](../../../assets/images/portswigger/fileupload/fu25.png)
...
![post request to repeater](../../../assets/images/portswigger/fileupload/fu26.png)
...
![sanitized filename](../../../assets/images/portswigger/fileupload/fu27.png)
...
![bypass with url encoding](../../../assets/images/portswigger/fileupload/fu28.png)
...
![edit in repeater](../../../assets/images/portswigger/fileupload/fu29.png)
...
![submit solution](../../../assets/images/portswigger/fileupload/fu30.png)

![lab3 solved](../../../assets/images/portswigger/fileupload/fu31.png)

---

*Web Shell Upload Via Extension Blacklist Bypass* 

![lab4 intro](../../../assets/images/portswigger/fileupload/fu32.png)
...
![login wiener upload file](../../../assets/images/portswigger/fileupload/fu33.png)

![php not allowed](../../../assets/images/portswigger/fileupload/fu34.png)
...
![php5 filetype](../../../assets/images/portswigger/fileupload/fu35.png)

![upload](../../../assets/images/portswigger/fileupload/fu36.png)

![accepted](../../../assets/images/portswigger/fileupload/fu37.png)
...
![apache server](../../../assets/images/portswigger/fileupload/fu38.png)
...
![.htaccess](../../../assets/images/portswigger/fileupload/fu39.png)
...
![you don't have permission](../../../assets/images/portswigger/fileupload/fu40.png)
...
![get testploit.php5](../../../assets/images/portswigger/fileupload/fu41.png)

I submit the string in the web browsers pop up box and the lab is marked as solved. 

![submit string](../../../assets/images/portswigger/fileupload/fu42.png)

![lab4 solved](../../../assets/images/portswigger/fileupload/fu43.png)

---

*Web  Shell Upload Via Obfuscated File Extension* 

![lab5 intro](../../../assets/images/portswigger/fileupload/fu44.png)
...
![login upload file](../../../assets/images/portswigger/fileupload/fu45.png)
...
![error message](../../../assets/images/portswigger/fileupload/fu46.png)
...
![and null byte](../../../assets/images/portswigger/fileupload/fu47.png)
...
![gets unsanitized file name](../../../assets/images/portswigger/fileupload/fu48.png)
...
![get secret key](../../../assets/images/portswigger/fileupload/fu49.png)

I submit the string into the solution box in the web browser and the lab is marked as solved. 

![submit string](../../../assets/images/portswigger/fileupload/fu50.png)

![lab5 solved](../../../assets/images/portswigger/fileupload/fu51.png)

---

*Remote Code Execution Via Polyglot Web Shell Upload* 

![lab6 intro](../../../assets/images/portswigger/fileupload/fu52.png)
...
![login and upload file](../../../assets/images/portswigger/fileupload/fu53.png)

![error message](../../../assets/images/portswigger/fileupload/fu54.png)
...
![exiftool](../../../assets/images/portswigger/fileupload/fu55.png)

When I try to upload this new `polyglot.php` file I can observe from the servers response that it was a success.

![my account avatar success](../../../assets/images/portswigger/fileupload/fu56.png)
...
![get secret code](../../../assets/images/portswigger/fileupload/fu57.png)

I enter the string into the submission box in the web browser and the lab is marked as solved. 

![lab6 solved](../../../assets/images/portswigger/fileupload/fu58.png)

---

*Web Shell Upload Via Race Condition* 

![lab7 intro](../../../assets/images/portswigger/fileupload/fu59.png)

Again to start this lab off I login with credentials `wiener:peter` and try to upload my `testploit.php` file. 

![login and upload file](../../../assets/images/portswigger/fileupload/fu60.png)
...
![post my account avatar](../../../assets/images/portswigger/fileupload/fu61.png)

![send to turbo intruder](../../../assets/images/portswigger/fileupload/fu62.png)
...
![upload actual image](../../../assets/images/portswigger/fileupload/fu63.png)
...
![python script in turbo intruder](../../../assets/images/portswigger/fileupload/fu64.png)
...
![copy POST /my account/avatar](../../../assets/images/portswigger/fileupload/fu65.png)
...
![copy 2nd request](../../../assets/images/portswigger/fileupload/fu66.png)
...
![edit request 2](../../../assets/images/portswigger/fileupload/fu67.png)
...
![200 response with secret](../../../assets/images/portswigger/fileupload/fu68.png)

I submit the string in the submissions box in the web browser and the lab is marked as solved. 

![submit string](../../../assets/images/portswigger/fileupload/fu69.png)

![lab7 solved](../../../assets/images/portswigger/fileupload/fu70.png)
