---
title: "Access Control; Context-Depedent Controls"
date: 2023-09-22
section: portswigger
---
...
![lab1 intro](../../../assets/images/portswigger/accesscontrol/contextdependant/cd01.png)

I start this lab off by navigating over to the `Live chat` page and sending a `test message`.  

![test message](../../../assets/images/portswigger/accesscontrol/contextdependant/cd02.png)

Now that I have a couple of messages in the transcript I went ahead and downloaded it.  

![download transcript](../../../assets/images/portswigger/accesscontrol/contextdependant/cd03.png)
...
![transcript request](../../../assets/images/portswigger/accesscontrol/contextdependant/cd04.png)
...
![password](../../../assets/images/portswigger/accesscontrol/contextdependant/cd05.png)

Now I just login with the credentials `carlos:1uird0f0llxtdmd539gv` and the lab gets marked as solved. 

![lab1 solved](../../../assets/images/portswigger/accesscontrol/contextdependant/cd06.png)

---

*Multi-Step Process With No Access Control On One Step* 

![lab2 intro](../../../assets/images/portswigger/accesscontrol/contextdependant/cd07.png)
...
![lab1 solved](../../../assets/images/portswigger/accesscontrol/contextdependant/cd08.png)
...
![upgrade carlos](../../../assets/images/portswigger/accesscontrol/contextdependant/cd09.png)

![upgrade request](../../../assets/images/portswigger/accesscontrol/contextdependant/cd10.png)

![admin roles redirect](../../../assets/images/portswigger/accesscontrol/contextdependant/cd11.png)
...
![upgrade command](../../../assets/images/portswigger/accesscontrol/contextdependant/cd12.png)
...
![my account page wiener](../../../assets/images/portswigger/accesscontrol/contextdependant/cd13.png)
...
![session cookie](../../../assets/images/portswigger/accesscontrol/contextdependant/cd14.png)
...
![place payloads](../../../assets/images/portswigger/accesscontrol/contextdependant/cd15.png)
...
![lab2 solved](../../../assets/images/portswigger/accesscontrol/contextdependant/cd16.png)
...
![lab3 intro](../../../assets/images/portswigger/accesscontrol/contextdependant/cd17.png)
...
![login admin](../../../assets/images/portswigger/accesscontrol/contextdependant/cd18.png)

![upgrade users](../../../assets/images/portswigger/accesscontrol/contextdependant/cd19.png)
...
![get request for upgrade](../../../assets/images/portswigger/accesscontrol/contextdependant/cd20.png)
...
![login wiener](../../../assets/images/portswigger/accesscontrol/contextdependant/cd21.png)
...
![copy session cookie](../../../assets/images/portswigger/accesscontrol/contextdependant/cd22.png)
...
![get adminroles](../../../assets/images/portswigger/accesscontrol/contextdependant/cd23.png)

This can be observed back in the browser where the lab is marked as solved and `wiener` now has access to the `admin panel`. 

![lab3 solved](../../../assets/images/portswigger/accesscontrol/contextdependant/cd24.png)
