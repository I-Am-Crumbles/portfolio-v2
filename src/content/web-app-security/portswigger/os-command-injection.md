...
![lab1](../../../assets/images/portswigger/oscommandinjection/osci01.png)
...
![check stock](../../../assets/images/portswigger/oscommandinjection/osci02.png)

![request](../../../assets/images/portswigger/oscommandinjection/osci03.png)
...
![edit request](../../../assets/images/portswigger/oscommandinjection/osci04.png)
...
![lab1 solved](../../../assets/images/portswigger/oscommandinjection/osci05.png)

---

*Blind OS Command Injection With Time Delays* 

![lab2](../../../assets/images/portswigger/oscommandinjection/osci06.png)
...
![submit feedback](../../../assets/images/portswigger/oscommandinjection/osci07.png)

![the literal feedback](../../../assets/images/portswigger/oscommandinjection/osci08.png)

![feedback request](../../../assets/images/portswigger/oscommandinjection/osci09.png)
...
![request with time dealy](../../../assets/images/portswigger/oscommandinjection/osci10.png)

Which was close enough to 10 seconds to satisfy the challenge for this lab. 

![lab2 solved](../../../assets/images/portswigger/oscommandinjection/osci11.png)

---

*Blind OS Command Injection With Output Redirection* 

![lab3](../../../assets/images/portswigger/oscommandinjection/osci12.png)
...
![submit feedback](../../../assets/images/portswigger/oscommandinjection/osci13.png)

![post request to repeater](../../../assets/images/portswigger/oscommandinjection/osci14.png)
...
![edit email](../../../assets/images/portswigger/oscommandinjection/osci15.png)
...
![open image in new tab](../../../assets/images/portswigger/oscommandinjection/osci16.png)

![image request](../../../assets/images/portswigger/oscommandinjection/osci17.png)
...
![edit request to image](../../../assets/images/portswigger/oscommandinjection/osci18.png)

Forwarding the request I can see the output of the `whoami` command `peter-qDfZTJ`. This completes the challenge for this lab. 

![lab3 solved](../../../assets/images/portswigger/oscommandinjection/osci19.png)

---

*Blind OS Command Injection With Out-Of-Band Interaction* 

![lab4](../../../assets/images/portswigger/oscommandinjection/osci20.png)
...
![submit feedback](../../../assets/images/portswigger/oscommandinjection/osci21.png)

![the literal feedback](../../../assets/images/portswigger/oscommandinjection/osci22.png)

![feedback request to repeater](../../../assets/images/portswigger/oscommandinjection/osci23.png)
...
![collaborator on](../../../assets/images/portswigger/oscommandinjection/osci24.png)
...
![editted request](../../../assets/images/portswigger/oscommandinjection/osci25.png)
...
![DNS query](../../../assets/images/portswigger/oscommandinjection/osci26.png)

This also completes the challenge for this lab. 

![lab4 solved](../../../assets/images/portswigger/oscommandinjection/osci27.png)

---

*Blind OS command Injection With Out-Of-Band Data Exfiltration* 

![lab5](../../../assets/images/portswigger/oscommandinjection/osci28.png)

 I'll need to again capture a request to submit feedback and forward it to the repeater. 

![submit feedback](../../../assets/images/portswigger/oscommandinjection/osci29.png)

![literal feedback](../../../assets/images/portswigger/oscommandinjection/osci30.png)

![feedback request](../../../assets/images/portswigger/oscommandinjection/osci31.png)

Next I need to start the *collaborator* so that I can craft my payload. 

![collaborator start](../../../assets/images/portswigger/oscommandinjection/osci32.png)
...
![editted request](../../../assets/images/portswigger/oscommandinjection/osci33.png)
...
![dns query](../../../assets/images/portswigger/oscommandinjection/osci34.png)

With the username in hand I just select *Submit Solution* at the top of the lab and paste it into the window that pops up.  

![submit](../../../assets/images/portswigger/oscommandinjection/osci35.png)

Once submitted the lab gets marked as solved. 

![lab5 solved](../../../assets/images/portswigger/oscommandinjection/osci36.png)
