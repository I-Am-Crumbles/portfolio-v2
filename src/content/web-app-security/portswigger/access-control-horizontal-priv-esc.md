---
title: "Access Control; Horizontal Privilege Escalation"
date: 2023-09-21
section: portswigger
---
...
![lab1 intro](../../../assets/images/portswigger/accesscontrol/horizontalprivesc/hp01.png)
...
![api key](../../../assets/images/portswigger/accesscontrol/horizontalprivesc/hp02.png)

I can observe from the request in burp that the query string for the user profile page ends in my username `wiener`. 

![get request](../../../assets/images/portswigger/accesscontrol/horizontalprivesc/hp03.png)
...
![edit url](../../../assets/images/portswigger/accesscontrol/horizontalprivesc/hp04.png)

If I click `Submit solution` at the top I can paste in the `API key` for user `carlos` and solve the lab. 

![submit solution](../../../assets/images/portswigger/accesscontrol/horizontalprivesc/hp05.png)

![lab1 solved](../../../assets/images/portswigger/accesscontrol/horizontalprivesc/hp06.png)

---

*User ID Controlled By Request Parameter, With Unpredictable User IDs* 

![lab2 intro](../../../assets/images/portswigger/accesscontrol/horizontalprivesc/hp07.png)
...
![login](../../../assets/images/portswigger/accesscontrol/horizontalprivesc/hp08.png)

![get /my-account](../../../assets/images/portswigger/accesscontrol/horizontalprivesc/hp09.png)
...
![browse posts](../../../assets/images/portswigger/accesscontrol/horizontalprivesc/hp10.png)

![blog author id](../../../assets/images/portswigger/accesscontrol/horizontalprivesc/hp11.png)
...
![api key](../../../assets/images/portswigger/accesscontrol/horizontalprivesc/hp12.png)

I can submit the found API key in the solution box and solve the lab. 

![submit solution](../../../assets/images/portswigger/accesscontrol/horizontalprivesc/hp13.png)

![lab2 solved](../../../assets/images/portswigger/accesscontrol/horizontalprivesc/hp14.png)

---

*User ID Controlled By Request Parameter With Data Leakage In Redirect* 

![lab3 intro](../../../assets/images/portswigger/accesscontrol/horizontalprivesc/hp15.png)
...
![login wiener](../../../assets/images/portswigger/accesscontrol/horizontalprivesc/hp16.png)

![get /my-account](../../../assets/images/portswigger/accesscontrol/horizontalprivesc/hp17.png)
...
![repeater](../../../assets/images/portswigger/accesscontrol/horizontalprivesc/hp18.png)

![carlos api key](../../../assets/images/portswigger/accesscontrol/horizontalprivesc/hp19.png)

I can submit this found API key in the solution box and solve the lab. 

![submit solution](../../../assets/images/portswigger/accesscontrol/horizontalprivesc/hp20.png)

![lab3 solved](../../../assets/images/portswigger/accesscontrol/horizontalprivesc/hp21.png)

---

*User ID Controlled By Request Parameter With Password Disclosure* 

![lab4 intro](../../../assets/images/portswigger/accesscontrol/horizontalprivesc/hp22.png)

To start this lab off I login with the provided user credentials `wiener:peter` 

![login](../../../assets/images/portswigger/accesscontrol/horizontalprivesc/hp23.png)
...
![plaintext password](../../../assets/images/portswigger/accesscontrol/horizontalprivesc/hp24.png)
...
![admin 200 ok](../../../assets/images/portswigger/accesscontrol/horizontalprivesc/hp25.png)
...
![admin plaintext](../../../assets/images/portswigger/accesscontrol/horizontalprivesc/hp26.png)
...
![admin login](../../../assets/images/portswigger/accesscontrol/horizontalprivesc/hp27.png)

To solve the lab I just navigate over to the admin panel and delete the user `carlos`. 

![delete carlos](../../../assets/images/portswigger/accesscontrol/horizontalprivesc/hp28.png)

![lab4 solved](../../../assets/images/portswigger/accesscontrol/horizontalprivesc/hp29.png)
