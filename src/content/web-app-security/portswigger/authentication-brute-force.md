---
title: "Authentication: Vulnerabilities In Password Based Login; Brute-Force Attacks"
date: 2023-08-13
section: portswigger
---
...
![lab1](../../../assets/images/portswigger/authentication/bruteforce/bf01.png)
...
![login](../../../assets/images/portswigger/authentication/bruteforce/bf02.png)

![request](../../../assets/images/portswigger/authentication/bruteforce/bf03.png)

The application responds with an *Invalid username* message. 

![invalid username](../../../assets/images/portswigger/authentication/bruteforce/bf04.png)
...
![intruder](../../../assets/images/portswigger/authentication/bruteforce/bf05.png)
...
![username payloads](../../../assets/images/portswigger/authentication/bruteforce/bf06.png)
...
![grep match](../../../assets/images/portswigger/authentication/bruteforce/bf07.png)
...
![length](../../../assets/images/portswigger/authentication/bruteforce/bf08.png)
...
![password position](../../../assets/images/portswigger/authentication/bruteforce/bf09.png)
...
![password payloads](../../../assets/images/portswigger/authentication/bruteforce/bf10.png)
...
![yankees](../../../assets/images/portswigger/authentication/bruteforce/bf11.png)

Back in the lab logging in with the credentials `aq:yankees` solves the challenge and completes the lab. 

![solved1](../../../assets/images/portswigger/authentication/bruteforce/bf12.png)

---

*Username Enumeration Via Subtly Different Responses* 

![lab2](../../../assets/images/portswigger/authentication/bruteforce/bf13.png)
...
![login](../../../assets/images/portswigger/authentication/bruteforce/bf14.png)

![intruder](../../../assets/images/portswigger/authentication/bruteforce/bf15.png)

![usernames payload](../../../assets/images/portswigger/authentication/bruteforce/bf16.png)
...
![auth](../../../assets/images/portswigger/authentication/bruteforce/bf17.png)
...
![password position](../../../assets/images/portswigger/authentication/bruteforce/bf18.png)

![passwords payload](../../../assets/images/portswigger/authentication/bruteforce/bf19.png)
...
![baseball](../../../assets/images/portswigger/authentication/bruteforce/bf20.png)

Logging in with the credentials `auth:baseball` completes the challenge for this lab. 

![solved2](../../../assets/images/portswigger/authentication/bruteforce/bf21.png)

---

*Username Enumeration Via Response Timing* 

![lab3](../../../assets/images/portswigger/authentication/bruteforce/bf22.png)
...
![wiener login](../../../assets/images/portswigger/authentication/bruteforce/bf23.png)
...
![crumbles login](../../../assets/images/portswigger/authentication/bruteforce/bf24.png)
...
![216 milli sec](../../../assets/images/portswigger/authentication/bruteforce/bf25.png)

`wiener:peter12345678900000000000` *265 milli seconds* 

![265 milli seconds](../../../assets/images/portswigger/authentication/bruteforce/bf26.png)
...
![crumbles 137 milli seconds](../../../assets/images/portswigger/authentication/bruteforce/bf27.png)
...
![rate limited](../../../assets/images/portswigger/authentication/bruteforce/bf28.png)

Luckily this challenge has a hint related to this issue. 

![hint](../../../assets/images/portswigger/authentication/bruteforce/bf29.png)
...
![x-forwarded-for](../../../assets/images/portswigger/authentication/bruteforce/bf30.png)
...
![pitchfork](../../../assets/images/portswigger/authentication/bruteforce/bf31.png)
...
![2 positions markers](../../../assets/images/portswigger/authentication/bruteforce/bf32.png)
...
![payload set 2](../../../assets/images/portswigger/authentication/bruteforce/bf33.png)
...
![payload set 1](../../../assets/images/portswigger/authentication/bruteforce/bf34.png)

With that all set up I can start the attack. 

![user user](../../../assets/images/portswigger/authentication/bruteforce/bf35.png)
...
![password positions](../../../assets/images/portswigger/authentication/bruteforce/bf36.png)
...
![password payload 2](../../../assets/images/portswigger/authentication/bruteforce/bf37.png)

Once the attack finishes I can see from the results that the password that prompted the *302 redirect* was `000000`. 

![000000](../../../assets/images/portswigger/authentication/bruteforce/bf38.png)

Logging in with the credentials `user:000000` completes the challenge for this lab. 

![solved 3](../../../assets/images/portswigger/authentication/bruteforce/bf39.png)
