---
title: "Business Logic Vulnerabilities; Domain Specific Flaws"
date: 2023-09-14
section: portswigger
---
...
![lab1 intro](../../../assets/images/portswigger/businesslogicvulns/domainspecific/ds01.png)
...
![login](../../../assets/images/portswigger/businesslogicvulns/domainspecific/ds02.png)
...
![sign up to our newsletter](../../../assets/images/portswigger/businesslogicvulns/domainspecific/ds03.png)

![sign up 30](../../../assets/images/portswigger/businesslogicvulns/domainspecific/ds04.png)

I put the `Lightweight "l33t" Leather Jacket` into my cart and apply the first coupon code `NEWCUST5`. 

![newcust5](../../../assets/images/portswigger/businesslogicvulns/domainspecific/ds05.png)

The coupon takes $5 off, but only once, subsequent uses generates an error. 

![minus 5](../../../assets/images/portswigger/businesslogicvulns/domainspecific/ds06.png)

![only once](../../../assets/images/portswigger/businesslogicvulns/domainspecific/ds07.png)

I can apply the other coupon I received `SIGNUP30` to further reduce the total by `$401.10`.  

![sign up 30](../../../assets/images/portswigger/businesslogicvulns/domainspecific/ds08.png)
...
![newcust5 works again](../../../assets/images/portswigger/businesslogicvulns/domainspecific/ds09.png)

The same can be observed by applying `SIGNUP30` again as well. 

![sign up 30](../../../assets/images/portswigger/businesslogicvulns/domainspecific/ds10.png)

Now I can just continue to apply the coupons in alternating order until the carts total reaches `$0`. 

![altertnate coupons til $0](../../../assets/images/portswigger/businesslogicvulns/domainspecific/ds11.png)

Now I just place the order and the lab gets marked as complete. 

![solved](../../../assets/images/portswigger/businesslogicvulns/domainspecific/ds12.png)
...
![lab2 intro](../../../assets/images/portswigger/businesslogicvulns/domainspecific/ds13.png)

 
I start this lab off by logging in with the provided credentials. 

![My Account](../../../assets/images/portswigger/businesslogicvulns/domainspecific/ds14.png)
...
![newsletter](../../../assets/images/portswigger/businesslogicvulns/domainspecific/ds15.png)

![signup30](../../../assets/images/portswigger/businesslogicvulns/domainspecific/ds16.png)

I can add a single gift card to my cart for `$10` and apply my coupon code so that it now costs `$7`. 

![$10 gift card](../../../assets/images/portswigger/businesslogicvulns/domainspecific/ds17.png)

![now cost 7](../../../assets/images/portswigger/businesslogicvulns/domainspecific/ds18.png)
...
![code](../../../assets/images/portswigger/businesslogicvulns/domainspecific/ds19.png)

![apply code](../../../assets/images/portswigger/businesslogicvulns/domainspecific/ds20.png)

![profit $3](../../../assets/images/portswigger/businesslogicvulns/domainspecific/ds21.png)
...
![second coupon](../../../assets/images/portswigger/businesslogicvulns/domainspecific/ds22.png)

![profit $3 again](../../../assets/images/portswigger/businesslogicvulns/domainspecific/ds23.png)
...
![session settings](../../../assets/images/portswigger/businesslogicvulns/domainspecific/ds24.png)

![add rule](../../../assets/images/portswigger/businesslogicvulns/domainspecific/ds25.png)
...
![run a macro](../../../assets/images/portswigger/businesslogicvulns/domainspecific/ds26.png)

![select request in order](../../../assets/images/portswigger/businesslogicvulns/domainspecific/ds27.png)
...
![configure item](../../../assets/images/portswigger/businesslogicvulns/domainspecific/ds28.png)
...
![custome parameter](../../../assets/images/portswigger/businesslogicvulns/domainspecific/ds29.png)

![define parameter and highlight code](../../../assets/images/portswigger/businesslogicvulns/domainspecific/ds30.png)
...
![configure post giftcard](../../../assets/images/portswigger/businesslogicvulns/domainspecific/ds31.png)
...
![configure prameter handling](../../../assets/images/portswigger/businesslogicvulns/domainspecific/ds32.png)
...
![macro tester](../../../assets/images/portswigger/businesslogicvulns/domainspecific/ds33.png)
...
![send to intruder](../../../assets/images/portswigger/businesslogicvulns/domainspecific/ds34.png)
...
![no payload positions](../../../assets/images/portswigger/businesslogicvulns/domainspecific/ds35.png)
...
![payload sets](../../../assets/images/portswigger/businesslogicvulns/domainspecific/ds36.png)
...
![resource pool](../../../assets/images/portswigger/businesslogicvulns/domainspecific/ds37.png)
...
![start attack](../../../assets/images/portswigger/businesslogicvulns/domainspecific/ds38.png)

![refresh cart](../../../assets/images/portswigger/businesslogicvulns/domainspecific/ds39.png)

It takes a minute but when the attack finishes I have enough credit to purchase my `Lightweight "l337" Leather Jacket`.  

![enough credit](../../../assets/images/portswigger/businesslogicvulns/domainspecific/ds40.png)

Adding it to the cart and placing the order solves the lab. 

![add to cart](../../../assets/images/portswigger/businesslogicvulns/domainspecific/ds41.png)

![solved2](../../../assets/images/portswigger/businesslogicvulns/domainspecific/ds42.png)

---

*Authentication Bypass Via Encryption Oracle* 

![lab3 intro](../../../assets/images/portswigger/businesslogicvulns/domainspecific/ds43.png)

To start this lab I'll log in with the provided credentials `wiener:peter` and make sure the *Stay Logged In* option checked 

![login](../../../assets/images/portswigger/businesslogicvulns/domainspecific/ds44.png)
...
![leave comment](../../../assets/images/portswigger/businesslogicvulns/domainspecific/ds45.png)

![comment request](../../../assets/images/portswigger/businesslogicvulns/domainspecific/ds46.png)
...
![second comment](../../../assets/images/portswigger/businesslogicvulns/domainspecific/ds47.png)

![second comment request](../../../assets/images/portswigger/businesslogicvulns/domainspecific/ds48.png)
...
![invalid email crumbles](../../../assets/images/portswigger/businesslogicvulns/domainspecific/ds49.png)
...
![test encryption](../../../assets/images/portswigger/businesslogicvulns/domainspecific/ds50.png)
...
![test in email repsonse](../../../assets/images/portswigger/businesslogicvulns/domainspecific/ds51.png)
...
![decrypt cookie](../../../assets/images/portswigger/businesslogicvulns/domainspecific/ds52.png)
...
![administrator cookie](../../../assets/images/portswigger/businesslogicvulns/domainspecific/ds53.png)
...
![invalid email added to string](../../../assets/images/portswigger/businesslogicvulns/domainspecific/ds54.png)
...
![decoder](../../../assets/images/portswigger/businesslogicvulns/domainspecific/ds55.png)
...
![delete bytes](../../../assets/images/portswigger/businesslogicvulns/domainspecific/ds56.png)
...
![reencode wrong input length](../../../assets/images/portswigger/businesslogicvulns/domainspecific/ds57.png)
...
![reencode with padding](../../../assets/images/portswigger/businesslogicvulns/domainspecific/ds58.png)
...
![decoder 2](../../../assets/images/portswigger/businesslogicvulns/domainspecific/ds59.png)

I take that new value and reverse the process by encoding it in *Base64 > URL* format.  

![base64 to url](../../../assets/images/portswigger/businesslogicvulns/domainspecific/ds60.png)
...
![admin cookie](../../../assets/images/portswigger/businesslogicvulns/domainspecific/ds61.png)
...
![get /](../../../assets/images/portswigger/businesslogicvulns/domainspecific/ds62.png)
...
![200 ok](../../../assets/images/portswigger/businesslogicvulns/domainspecific/ds63.png)

![show response in browser](../../../assets/images/portswigger/businesslogicvulns/domainspecific/ds64.png)
...
![admin panel](../../../assets/images/portswigger/businesslogicvulns/domainspecific/ds65.png)

Now I just need to navigate over to that admin panel, delete user *carlos*, and the lab will be marked as solved. 

![delete carlos](../../../assets/images/portswigger/businesslogicvulns/domainspecific/ds66.png)

![solved 3](../../../assets/images/portswigger/businesslogicvulns/domainspecific/ds67.png)
