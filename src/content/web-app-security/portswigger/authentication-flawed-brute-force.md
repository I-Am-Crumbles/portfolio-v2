---
title: "Authentication: Vulnerabilities In Password Based Login; Flawed Brute-Force Protection"
date: 2023-08-16
section: portswigger
---
...
![lab1](../../../assets/images/portswigger/authentication/flawedbruteforce/fbf01.png)

To start this lab I capture a request to login with the provided credentials and send it to the *repeater*. 

![request](../../../assets/images/portswigger/authentication/flawedbruteforce/fbf02.png)
...
![incorrect password](../../../assets/images/portswigger/authentication/flawedbruteforce/fbf03.png)

![payload position peter](../../../assets/images/portswigger/authentication/flawedbruteforce/fbf04.png)

![payload sets1](../../../assets/images/portswigger/authentication/flawedbruteforce/fbf05.png)

![different error](../../../assets/images/portswigger/authentication/flawedbruteforce/fbf06.png)
...
![pitchfork](../../../assets/images/portswigger/authentication/flawedbruteforce/fbf07.png)

![section signs](../../../assets/images/portswigger/authentication/flawedbruteforce/fbf08.png)
...
![resource pool](../../../assets/images/portswigger/authentication/flawedbruteforce/fbf09.png)
...
![payload set 1](../../../assets/images/portswigger/authentication/flawedbruteforce/fbf10.png)
...
![Payload Set2](../../../assets/images/portswigger/authentication/flawedbruteforce/fbf12.png)
...
![george](../../../assets/images/portswigger/authentication/flawedbruteforce/fbf13.png)

logging in with the credentials `carlos:george` solves the challenge for this lab. 

![solved](../../../assets/images/portswigger/authentication/flawedbruteforce/fbf14.png)

---

*Username Enumeration Via Account Lock*

![lab2](../../../assets/images/portswigger/authentication/flawedbruteforce/fbf15.png)
...
![clusterbomb](../../../assets/images/portswigger/authentication/flawedbruteforce/fbf16.png)
...
![section signs](../../../assets/images/portswigger/authentication/flawedbruteforce/fbf17.png)
...
![payload settings](../../../assets/images/portswigger/authentication/flawedbruteforce/fbf18.png)
...
![generate 5 payloads](../../../assets/images/portswigger/authentication/flawedbruteforce/fbf19.png)
...
![too many attempts](../../../assets/images/portswigger/authentication/flawedbruteforce/fbf20.png)
...
![intruder 2](../../../assets/images/portswigger/authentication/flawedbruteforce/fbf21.png)
...
![password sesction signs](../../../assets/images/portswigger/authentication/flawedbruteforce/fbf22.png)
...
![payload set](../../../assets/images/portswigger/authentication/flawedbruteforce/fbf23.png)
...
![grept extract](../../../assets/images/portswigger/authentication/flawedbruteforce/fbf24.png)
...
![password](../../../assets/images/portswigger/authentication/flawedbruteforce/fbf25.png)

Logging in with the credentials `ae:michael` solves the challenge and completes this lab.

![solved2](../../../assets/images/portswigger/authentication/flawedbruteforce/fbf26.png)

---

*Broken Brute-Force Protection, Multiple Credentials Per Request*

![lab 3](../../../assets/images/portswigger/authentication/flawedbruteforce/fbf27.png)

To start this lab off I captured a regular login request and sent it over to the repeater. 

![repeater](../../../assets/images/portswigger/authentication/flawedbruteforce/fbf28.png)
...
![payload](../../../assets/images/portswigger/authentication/flawedbruteforce/fbf29.png)

If everything is formatted correctly the application will respond with a *302 redirect*. 

![302](../../../assets/images/portswigger/authentication/flawedbruteforce/fbf30.png)
...
![show in browser](../../../assets/images/portswigger/authentication/flawedbruteforce/fbf31.png)

![url](../../../assets/images/portswigger/authentication/flawedbruteforce/fbf32.png)

![solved3](../../../assets/images/portswigger/authentication/flawedbruteforce/fbf33.png)
