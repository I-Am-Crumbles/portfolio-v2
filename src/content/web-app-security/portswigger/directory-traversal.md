...
![lab1](../../../assets/images/portswigger/directorytraversal/dt01.png)
...
![image in new tab](../../../assets/images/portswigger/directorytraversal/dt02.png)

![Request in repeater](../../../assets/images/portswigger/directorytraversal/dt03.png)
...
![payload request](../../../assets/images/portswigger/directorytraversal/dt04.png)

Back on the target webpage the lab gets marked as solved at the top. 

![lab1 solved](../../../assets/images/portswigger/directorytraversal/dt05.png)

---

*File Path Traversal, Traversal Sequences Blocked With Absolute Path Bypass* 

![lab2](../../../assets/images/portswigger/directorytraversal/dt06.png)
...
![image in new tab](../../../assets/images/portswigger/directorytraversal/dt07.png)
...
![solve payload](../../../assets/images/portswigger/directorytraversal/dt08.png)

![lab2 solved](../../../assets/images/portswigger/directorytraversal/dt09.png)

---

*File Path, Traversal Sequences Stripped Non-Recursively*

![lab3](../../../assets/images/portswigger/directorytraversal/dt10.png)
...
![image in new tab](../../../assets/images/portswigger/directorytraversal/dt11.png)

![request](../../../assets/images/portswigger/directorytraversal/dt12.png)
...
![solve payload](../../../assets/images/portswigger/directorytraversal/dt13.png)

![lab3 solved](../../../assets/images/portswigger/directorytraversal/dt14.png)

---

*File Path Traversal, Traversal Sequences Stripped With Superfluous URL Decode* 

![lab4 ](../../../assets/images/portswigger/directorytraversal/dt15.png)

Again for this lab I capture a request to open one of the product images in a new window and send it to the repeater. 

![image in new tab](../../../assets/images/portswigger/directorytraversal/dt16.png)

![image request to repeater](../../../assets/images/portswigger/directorytraversal/dt17.png)
...
![lab4 payload request](../../../assets/images/portswigger/directorytraversal/dt18.png)

![lab4 solved](../../../assets/images/portswigger/directorytraversal/dt19.png)

---

*File Path Traversal, Validation Of Start Of Path* 

![lab5](../../../assets/images/portswigger/directorytraversal/dt20.png)

Like the previous labs I need to capture a request for one of the product images and send it off to the repeater. 

![image in new tab](../../../assets/images/portswigger/directorytraversal/dt21.png)

![image request](../../../assets/images/portswigger/directorytraversal/dt22.png)
...
![lab5 payload request](../../../assets/images/portswigger/directorytraversal/dt23.png)

This retrieves the contents of the */etc/passwd* file and solves the challenge for this lab. 

![lab5 solved](../../../assets/images/portswigger/directorytraversal/dt24.png)

---

*File Path Traversal, Validation Of File Extension With Null Byte Bypass* 

![lab6](../../../assets/images/portswigger/directorytraversal/dt25.png)

Once again I'll need to capture a request for one of the product images and send it to the repeater. 

![image in new tab](../../../assets/images/portswigger/directorytraversal/dt26.png)

![image request in repeater](../../../assets/images/portswigger/directorytraversal/dt27.png)
...
![lab5 solve payload](../../../assets/images/portswigger/directorytraversal/dt28.png)

Since the request returned the contents of the `/etc/passwd` file the challenge gets marked as solved for this lab. 

![lab6 solved](../../../assets/images/portswigger/directorytraversal/dt29.png)
