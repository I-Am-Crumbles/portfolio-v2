---
title: "Access Control; Vertical Privilege Escalation"
date: 2023-09-19
section: portswigger
---
...
![lab1 intro](../../../assets/images/portswigger/accesscontrol/verticleprivesc/vp01.png)

I started this lab off with a content discovery scan. 

![content discovery](../../../assets/images/portswigger/accesscontrol/verticleprivesc/vp02.png)
...
![robots.txt](../../../assets/images/portswigger/accesscontrol/verticleprivesc/vp03.png)

Just navigating over to that end point solves the lab, I didn't even have to actually delete the user. 

![lab1 solved](../../../assets/images/portswigger/accesscontrol/verticleprivesc/vp04.png)

---

*Unprotected Admin Functionality With Unpredictable URL* 

![lab2 intro](../../../assets/images/portswigger/accesscontrol/verticleprivesc/vp05.png)
...
![lab2 script](../../../assets/images/portswigger/accesscontrol/verticleprivesc/vp06.png)
...
![obfuscated end point](../../../assets/images/portswigger/accesscontrol/verticleprivesc/vp07.png)

I delete user *Carlos* and the lab is marked as solved. 

![lab2 delete carlos](../../../assets/images/portswigger/accesscontrol/verticleprivesc/vp08.png)

![lab2 solved](../../../assets/images/portswigger/accesscontrol/verticleprivesc/vp09.png)

---

*User Role Controlled By Request Parameter* 

![lab3 intro](../../../assets/images/portswigger/accesscontrol/verticleprivesc/vp10.png)

To start this lab off I login with the provided credentials `wiener:peter` 

![login wiener](../../../assets/images/portswigger/accesscontrol/verticleprivesc/vp11.png)
...
![admin endpoint](../../../assets/images/portswigger/accesscontrol/verticleprivesc/vp12.png)
...
![admin = false](../../../assets/images/portswigger/accesscontrol/verticleprivesc/vp13.png)

![admin = true](../../../assets/images/portswigger/accesscontrol/verticleprivesc/vp14.png)
...
![show in browser](../../../assets/images/portswigger/accesscontrol/verticleprivesc/vp15.png)

![delete carlos](../../../assets/images/portswigger/accesscontrol/verticleprivesc/vp16.png)
...
![new request admin = false](../../../assets/images/portswigger/accesscontrol/verticleprivesc/vp17.png)
...
![admin = true again](../../../assets/images/portswigger/accesscontrol/verticleprivesc/vp18.png)

![lab3 solved](../../../assets/images/portswigger/accesscontrol/verticleprivesc/vp19.png)

---

*User Role Can Be Modified In User Profile* 

![lab4 intro](../../../assets/images/portswigger/accesscontrol/verticleprivesc/vp20.png)

I start this lab off by logging in with the provided credentials  

![lab4 login wiener](../../../assets/images/portswigger/accesscontrol/verticleprivesc/vp21.png)
...
![admin panel for admin only](../../../assets/images/portswigger/accesscontrol/verticleprivesc/vp22.png)

![/admin request](../../../assets/images/portswigger/accesscontrol/verticleprivesc/vp23.png)
...
![update email](../../../assets/images/portswigger/accesscontrol/verticleprivesc/vp24.png)
...
![302 found](../../../assets/images/portswigger/accesscontrol/verticleprivesc/vp25.png)
...
![hidden fields](../../../assets/images/portswigger/accesscontrol/verticleprivesc/vp26.png)

This was verified by refreshing the `My Account` page and seeing that I now have access to the *Admin Panel*. 

![my account page](../../../assets/images/portswigger/accesscontrol/verticleprivesc/vp27.png)

From there I just navigate over to the *Admin panel* and delete user `carlos` to solve the lab. 

![lab4 delete carlos](../../../assets/images/portswigger/accesscontrol/verticleprivesc/vp28.png)

![lab4 solved](../../../assets/images/portswigger/accesscontrol/verticleprivesc/vp29.png)

---

*URL-Based Access Control Can Be Circumvented* 

![lab5 intro](../../../assets/images/portswigger/accesscontrol/verticleprivesc/vp30.png)
...
![admin panel](../../../assets/images/portswigger/accesscontrol/verticleprivesc/vp31.png)

![access denied](../../../assets/images/portswigger/accesscontrol/verticleprivesc/vp32.png)
...
![x original url](../../../assets/images/portswigger/accesscontrol/verticleprivesc/vp33.png)

![show response in browser](../../../assets/images/portswigger/accesscontrol/verticleprivesc/vp34.png)

![delete carlos](../../../assets/images/portswigger/accesscontrol/verticleprivesc/vp35.png)

However trying to `delete carlos` fails with the same access denied error page as before. 

![access denied](../../../assets/images/portswigger/accesscontrol/verticleprivesc/vp36.png)
...
![burp repeater](../../../assets/images/portswigger/accesscontrol/verticleprivesc/vp37.png)

![lab5 solved](../../../assets/images/portswigger/accesscontrol/verticleprivesc/vp38.png)

---

*Method-based Access Control Can Be Circumvented* 

![lab6 intro](../../../assets/images/portswigger/accesscontrol/verticleprivesc/vp39.png)
...
![my account admin](../../../assets/images/portswigger/accesscontrol/verticleprivesc/vp40.png)

![wiener normal](../../../assets/images/portswigger/accesscontrol/verticleprivesc/vp41.png)
...
![/admin-roles](../../../assets/images/portswigger/accesscontrol/verticleprivesc/vp42.png)
...
![login wiener](../../../assets/images/portswigger/accesscontrol/verticleprivesc/vp43.png)

![admin interface](../../../assets/images/portswigger/accesscontrol/verticleprivesc/vp44.png)
...
![session cookie](../../../assets/images/portswigger/accesscontrol/verticleprivesc/vp45.png)
...
![post /admin-roles](../../../assets/images/portswigger/accesscontrol/verticleprivesc/vp46.png)
...
![get /admin-roles](../../../assets/images/portswigger/accesscontrol/verticleprivesc/vp47.png)

![lab6 solved](../../../assets/images/portswigger/accesscontrol/verticleprivesc/vp48.png)
