---
title: "Race Conditions Continued"
date: 2023-10-15
section: portswigger
---
...
![lab1 intro](../../../assets/images/portswigger/raceconditionscontinued/rcc01.png)
...
![lab1 login](../../../assets/images/portswigger/raceconditionscontinued/rcc02.png)

![check email message](../../../assets/images/portswigger/raceconditionscontinued/rcc03.png)
...
![email client](../../../assets/images/portswigger/raceconditionscontinued/rcc04.png)
...
![resources/static/users](../../../assets/images/portswigger/raceconditionscontinued/rcc05.png)
...
![/confirm token](../../../assets/images/portswigger/raceconditionscontinued/rcc06.png)

If I remove the token parameter altogether, `POST /confirm`, I get an error message telling me that it's missing. 

![token missing](../../../assets/images/portswigger/raceconditionscontinued/rcc07.png)
...
![incorrect token array](../../../assets/images/portswigger/raceconditionscontinued/rcc08.png)
...
![POST /register](../../../assets/images/portswigger/raceconditionscontinued/rcc09.png)

I'm going to create a group containing the `POST /register` request and the `POST /confirm?token=1` request. 

![create a group](../../../assets/images/portswigger/raceconditionscontinued/rcc10.png)
...
![slower1](../../../assets/images/portswigger/raceconditionscontinued/rcc11.png)

![slower2](../../../assets/images/portswigger/raceconditionscontinued/rcc12.png)
...
![/register](../../../assets/images/portswigger/raceconditionscontinued/rcc13.png)
...
![Turbo intruder](../../../assets/images/portswigger/raceconditionscontinued/rcc14.png)
...
![Edit python script](../../../assets/images/portswigger/raceconditionscontinued/rcc15.png)
...
![run attack](../../../assets/images/portswigger/raceconditionscontinued/rcc16.png)
...
![login](../../../assets/images/portswigger/raceconditionscontinued/rcc17.png)

If I navigate over to that `Admin panel` I have the option to `delete carlos` and doing so solves the lab. 

![delete carlos](../../../assets/images/portswigger/raceconditionscontinued/rcc18.png)

![lab1 solved](../../../assets/images/portswigger/raceconditionscontinued/rcc19.png)

---

*Exploring Time-Sensitive Vulnerabilities* 

![lab2 intro](../../../assets/images/portswigger/raceconditionscontinued/rcc20.png)
...
![forgot password](../../../assets/images/portswigger/raceconditionscontinued/rcc21.png)
...
![enter email](../../../assets/images/portswigger/raceconditionscontinued/rcc22.png)

![locate the email](../../../assets/images/portswigger/raceconditionscontinued/rcc23.png)
...
![please check for reset link](../../../assets/images/portswigger/raceconditionscontinued/rcc24.png)

I noted that I can see the username `wiener` within the link along with some form of `token`. 

![the email link](../../../assets/images/portswigger/raceconditionscontinued/rcc25.png)
...
![post forgot password](../../../assets/images/portswigger/raceconditionscontinued/rcc26.png)

![create group](../../../assets/images/portswigger/raceconditionscontinued/rcc27.png)
...
![tab1 time](../../../assets/images/portswigger/raceconditionscontinued/rcc28.png)

![tab2 time](../../../assets/images/portswigger/raceconditionscontinued/rcc29.png)
...
![different tokens](../../../assets/images/portswigger/raceconditionscontinued/rcc30.png)
...
![GET /forgot password](../../../assets/images/portswigger/raceconditionscontinued/rcc31.png)
...
![remove cookie header](../../../assets/images/portswigger/raceconditionscontinued/rcc32.png)

![grab CSRF token](../../../assets/images/portswigger/raceconditionscontinued/rcc33.png)
...
![edit tab2](../../../assets/images/portswigger/raceconditionscontinued/rcc34.png)
...
![only one reset link](../../../assets/images/portswigger/raceconditionscontinued/rcc35.png)
...
![change password](../../../assets/images/portswigger/raceconditionscontinued/rcc36.png)
...
![burp login](../../../assets/images/portswigger/raceconditionscontinued/rcc37.png)

![admin panel](../../../assets/images/portswigger/raceconditionscontinued/rcc38.png)

To solve the lab I just need to navigate over to that `Admin panel` and delete user `carlos`. 

![delete carlos](../../../assets/images/portswigger/raceconditionscontinued/rcc39.png)

![lab2 solved](../../../assets/images/portswigger/raceconditionscontinued/rcc40.png)
