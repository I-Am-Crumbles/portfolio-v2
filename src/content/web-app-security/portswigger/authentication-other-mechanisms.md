---
title: "Authentication: Vulnerabilities In Other Authentication Mechanisms"
date: 2023-08-26
section: portswigger
---
...
![lab1](../../../assets/images/portswigger/authentication/othermechanisms/oam01.png)
...
![login](../../../assets/images/portswigger/authentication/othermechanisms/oam02.png)

![login request](../../../assets/images/portswigger/authentication/othermechanisms/oam03.png)
...
![base64 decode](../../../assets/images/portswigger/authentication/othermechanisms/oam04.png)
...
![md5 password](../../../assets/images/portswigger/authentication/othermechanisms/oam05.png)
...
![send to intruder](../../../assets/images/portswigger/authentication/othermechanisms/oam06.png)
...
![payload position](../../../assets/images/portswigger/authentication/othermechanisms/oam07.png)
...
![payload set](../../../assets/images/portswigger/authentication/othermechanisms/oam08.png)
...
![md5 rule](../../../assets/images/portswigger/authentication/othermechanisms/oam09.png)

![add prefix rule](../../../assets/images/portswigger/authentication/othermechanisms/oam10.png)

![decode rule](../../../assets/images/portswigger/authentication/othermechanisms/oam11.png)
...
![run test](../../../assets/images/portswigger/authentication/othermechanisms/oam12.png)
...
![edit carlos positions](../../../assets/images/portswigger/authentication/othermechanisms/oam13.png)
...
![wordlist payload](../../../assets/images/portswigger/authentication/othermechanisms/oam14.png)

I also need to replace *wiener* with *carlos* in the *Addprefix* processing rule.

![change prefix](../../../assets/images/portswigger/authentication/othermechanisms/oam15.png)
...
![grep match](../../../assets/images/portswigger/authentication/othermechanisms/oam16.png)

![attack 200 response](../../../assets/images/portswigger/authentication/othermechanisms/oam17.png)
...
![solved](../../../assets/images/portswigger/authentication/othermechanisms/oam18.png)

---

*Offline Password Cracking*

![lab2](../../../assets/images/portswigger/authentication/othermechanisms/oam19.png)
...
![login](../../../assets/images/portswigger/authentication/othermechanisms/oam20.png)

![login request](../../../assets/images/portswigger/authentication/othermechanisms/oam21.png)

The cookie is the same as the previous challenge. A base64 encoding of the username and the md5sum of their password. 

![bas64 decode](../../../assets/images/portswigger/authentication/othermechanisms/oam22.png)

![password m5dsum](../../../assets/images/portswigger/authentication/othermechanisms/oam23.png)
...
![pick a post](../../../assets/images/portswigger/authentication/othermechanisms/oam24.png)

![test payload](../../../assets/images/portswigger/authentication/othermechanisms/oam25.png)

I can then navigate back to the page I left the comment on and see that the alert is generated.  

![test alert](../../../assets/images/portswigger/authentication/othermechanisms/oam26.png)
...
![exploit server](../../../assets/images/portswigger/authentication/othermechanisms/oam27.png)
...
![comment real payload](../../../assets/images/portswigger/authentication/othermechanisms/oam28.png)
...
![access log](../../../assets/images/portswigger/authentication/othermechanisms/oam29.png)

![stay logged in cookie](../../../assets/images/portswigger/authentication/othermechanisms/oam30.png)
...
![base64 decode](../../../assets/images/portswigger/authentication/othermechanisms/oam31.png)
...
![crackstation](../../../assets/images/portswigger/authentication/othermechanisms/oam32.png)

Now that I have their credentials I just need to log into and delete the account for user *carlos*. 

![delete account](../../../assets/images/portswigger/authentication/othermechanisms/oam33.png)

![really sure](../../../assets/images/portswigger/authentication/othermechanisms/oam34.png)

Once the account is deleted the challenge is marked as *solved* on the webpage completing this lab. 

![solved2](../../../assets/images/portswigger/authentication/othermechanisms/oam35.png)
...
![lab3](../../../assets/images/portswigger/authentication/othermechanisms/oam36.png)
...
![forgot password](../../../assets/images/portswigger/authentication/othermechanisms/oam37.png)

![enter wiener](../../../assets/images/portswigger/authentication/othermechanisms/oam38.png)

![email client](../../../assets/images/portswigger/authentication/othermechanisms/oam39.png)
...
![request](../../../assets/images/portswigger/authentication/othermechanisms/oam40.png)
...
![change to carlos](../../../assets/images/portswigger/authentication/othermechanisms/oam41.png)
...
![solved3](../../../assets/images/portswigger/authentication/othermechanisms/oam42.png)
...
![lab4](../../../assets/images/portswigger/authentication/othermechanisms/oam43.png)
...
![request to forgot password](../../../assets/images/portswigger/authentication/othermechanisms/oam44.png)
...
![edit request](../../../assets/images/portswigger/authentication/othermechanisms/oam45.png)
...
![access log](../../../assets/images/portswigger/authentication/othermechanisms/oam46.png)

![token](../../../assets/images/portswigger/authentication/othermechanisms/oam47.png)
...
![fresh reset link](../../../assets/images/portswigger/authentication/othermechanisms/oam48.png)
...
![request carlos change](../../../assets/images/portswigger/authentication/othermechanisms/oam49.png)

Now I just log in as the user with the new credentials `carlos:crumbles` and the lab is marked as solved. 

![solved4](../../../assets/images/portswigger/authentication/othermechanisms/oam50.png)

---

*Password Brute-Force Via Password Change*

![lab5](../../../assets/images/portswigger/authentication/othermechanisms/oam51.png)
...
![change password](../../../assets/images/portswigger/authentication/othermechanisms/oam52.png)

![successful change](../../../assets/images/portswigger/authentication/othermechanisms/oam53.png)
...
![lockout](../../../assets/images/portswigger/authentication/othermechanisms/oam54.png)
...
![new passwords do not match](../../../assets/images/portswigger/authentication/othermechanisms/oam55.png)

If I enter the wrong password but the new passwords match the web application simply redirects me to the login page. 

![login redirect](../../../assets/images/portswigger/authentication/othermechanisms/oam56.png)
...
![current password incorrect](../../../assets/images/portswigger/authentication/othermechanisms/oam57.png)
...
![intruder](../../../assets/images/portswigger/authentication/othermechanisms/oam58.png)
...
![set payload](../../../assets/images/portswigger/authentication/othermechanisms/oam59.png)
...
![grep match](../../../assets/images/portswigger/authentication/othermechanisms/oam60.png)
...
![pepper](../../../assets/images/portswigger/authentication/othermechanisms/oam61.png)

Logging in with the credentials `carlos:pepper` completes the challenge for this lab. 

![solved5](../../../assets/images/portswigger/authentication/othermechanisms/oam62.png)
