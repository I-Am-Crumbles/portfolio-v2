...
![lab1 intro](../../../assets/images/portswigger/raceconditions/rc01.png)
...
![login](../../../assets/images/portswigger/raceconditions/rc02.png)

Per the instructions in the labs challenge I'm to buy a `Lightweight "l33t" Leather Jacket` that costs `$1337.00` 

![lab1 jacket price](../../../assets/images/portswigger/raceconditions/rc03.png)
...
![promo20](../../../assets/images/portswigger/raceconditions/rc04.png)

![post /cart/coup](../../../assets/images/portswigger/raceconditions/rc05.png)
...
![post cart coupon 4x](../../../assets/images/portswigger/raceconditions/rc06.png)
...
![create tab group](../../../assets/images/portswigger/raceconditions/rc07.png)

![new group](../../../assets/images/portswigger/raceconditions/rc08.png)
...
![send in parallel](../../../assets/images/portswigger/raceconditions/rc09.png)
...
![race condition proven](../../../assets/images/portswigger/raceconditions/rc10.png)
...
![35 tabs at once](../../../assets/images/portswigger/raceconditions/rc11.png)

From there I just click the `Place order` button and the lab is marked as solved. 

![lab1 solved](../../../assets/images/portswigger/raceconditions/rc12.png)

---

*Bypassing Rate Limits Via Race Conditions* 

![lab2 intro](../../../assets/images/portswigger/raceconditions/rc13.png)
...
![lab passwords](../../../assets/images/portswigger/raceconditions/rc14.png)
...
![Login provided creds](../../../assets/images/portswigger/raceconditions/rc15.png)
...
![lockout time](../../../assets/images/portswigger/raceconditions/rc16.png)

![POST /login](../../../assets/images/portswigger/raceconditions/rc17.png)
...
![login wiener](../../../assets/images/portswigger/raceconditions/rc18.png)

The more successive fails in a row the longer the lock out period is each time. 

![fails take longer](../../../assets/images/portswigger/raceconditions/rc19.png)
...
![send to turbo intruder](../../../assets/images/portswigger/raceconditions/rc20.png)
...
![python script edited](../../../assets/images/portswigger/raceconditions/rc21.png)
...
![302 response](../../../assets/images/portswigger/raceconditions/rc22.png)

I used the credentials `carlos:dragon` and see that I'm greeted with a page that has direct access to the `Admin panel`.

![login carlos](../../../assets/images/portswigger/raceconditions/rc23.png)
...
![/admin/delete/username=carlos](../../../assets/images/portswigger/raceconditions/rc24.png)

![lab2 solved](../../../assets/images/portswigger/raceconditions/rc25.png)

---

*Multi-endpoint Race Conditions* 

![lab3 Intro](../../../assets/images/portswigger/raceconditions/rc26.png)
...
![login my account](../../../assets/images/portswigger/raceconditions/rc27.png)
...
![POST /cart](../../../assets/images/portswigger/raceconditions/rc28.png)

![POST /cart continued](../../../assets/images/portswigger/raceconditions/rc29.png)

I sent both of these requests to the repeater and created a group for them. 

![create group](../../../assets/images/portswigger/raceconditions/rc30.png)
...
![508 millis](../../../assets/images/portswigger/raceconditions/rc31.png)

![147 millis](../../../assets/images/portswigger/raceconditions/rc32.png)
...
![add giftcard](../../../assets/images/portswigger/raceconditions/rc33.png)
...
![edit request](../../../assets/images/portswigger/raceconditions/rc34.png)

![Order is on the way](../../../assets/images/portswigger/raceconditions/rc35.png)
...
![lab3 solved](../../../assets/images/portswigger/raceconditions/rc36.png)

---

*Single-endpoint Race Conditions* 

![lab4 intro](../../../assets/images/portswigger/raceconditions/rc37.png)
...
![login](../../../assets/images/portswigger/raceconditions/rc38.png)

![email client](../../../assets/images/portswigger/raceconditions/rc39.png)
...
![confirm email change](../../../assets/images/portswigger/raceconditions/rc40.png)
...
![post /myaccount change email](../../../assets/images/portswigger/raceconditions/rc41.png)
...
![edit email](../../../assets/images/portswigger/raceconditions/rc42.png)
...
![create group](../../../assets/images/portswigger/raceconditions/rc43.png)

![single packet attack](../../../assets/images/portswigger/raceconditions/rc44.png)

Once I forward the requests I can observe the server responds with a 302 for both requests. 

![302 response](../../../assets/images/portswigger/raceconditions/rc45.png)

![tab2](../../../assets/images/portswigger/raceconditions/rc46.png)
...
![email link](../../../assets/images/portswigger/raceconditions/rc47.png)
...
![email is now carlos](../../../assets/images/portswigger/raceconditions/rc48.png)
...
![delete carlos](../../../assets/images/portswigger/raceconditions/rc49.png)

![lab4 solved](../../../assets/images/portswigger/raceconditions/rc50.png)
