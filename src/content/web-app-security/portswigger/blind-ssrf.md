...
![lab1 intro](../../../assets/images/portswigger/blindssrf/bssrf01.png)
...
![lab1 workflow](../../../assets/images/portswigger/blindssrf/bssrf02.png)

I'll then need to start the collaborator and copy it's URL to the clipboard. 

![collaborator start](../../../assets/images/portswigger/blindssrf/bssrf03.png)
...
![edit referer header](../../../assets/images/portswigger/blindssrf/bssrf04.png)

![dns query in colaborator](../../../assets/images/portswigger/blindssrf/bssrf05.png)
...
![lab1 solved](../../../assets/images/portswigger/blindssrf/bssrf06.png)

---

*Blind SSRF With Shellshock Exploitation* 

![lab2 intro](../../../assets/images/portswigger/blindssrf/bssrf07.png)
...
![workflow](../../../assets/images/portswigger/blindssrf/bssrf08.png)

![start collaborator](../../../assets/images/portswigger/blindssrf/bssrf09.png)
...
![intruder edits](../../../assets/images/portswigger/blindssrf/bssrf10.png)
...
![edit payload](../../../assets/images/portswigger/blindssrf/bssrf11.png)
...
![attack results](../../../assets/images/portswigger/blindssrf/bssrf12.png)

However If I check the logs in the collaborator I can see a DNS query from the server containing a username `peter-Lr0q1U`. 

![collaborator logs](../../../assets/images/portswigger/blindssrf/bssrf13.png)

Back in the web browser I can submit the username I found as a solution and see that the lab gets marked as solved. 

![submit solution](../../../assets/images/portswigger/blindssrf/bssrf14.png)

![lab2 solved](../../../assets/images/portswigger/blindssrf/bssrf15.png)
