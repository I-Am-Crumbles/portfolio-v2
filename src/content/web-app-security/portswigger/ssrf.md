...
![lab1 intro](../../../assets/images/portswigger/ssrf/ssrf01.png)
...
![check stock](../../../assets/images/portswigger/ssrf/ssrf02.png)
...
![stock api request](../../../assets/images/portswigger/ssrf/ssrf03.png)
...
![edit in repeater](../../../assets/images/portswigger/ssrf/ssrf04.png)

![shown in browser](../../../assets/images/portswigger/ssrf/ssrf05.png)
...
![must come from loopback](../../../assets/images/portswigger/ssrf/ssrf06.png)
...
![302 redirect](../../../assets/images/portswigger/ssrf/ssrf07.png)

This can be confirmed in the web browser by refreshing the home page as the lab is now marked as solved.  

![lab1 solved](../../../assets/images/portswigger/ssrf/ssrf08.png)

---

Basic SSRF Against Another Back-End System* 

![lab2 intro](../../../assets/images/portswigger/ssrf/ssrf09.png)
...
![product/stock to repeater](../../../assets/images/portswigger/ssrf/ssrf10.png)
...
![edit intruder](../../../assets/images/portswigger/ssrf/ssrf11.png)
...
![payload tab](../../../assets/images/portswigger/ssrf/ssrf12.png)
...
![200 response](../../../assets/images/portswigger/ssrf/ssrf13.png)

![admin panel](../../../assets/images/portswigger/ssrf/ssrf14.png)
...
![can't delete](../../../assets/images/portswigger/ssrf/ssrf15.png)
...
![edit in repeater](../../../assets/images/portswigger/ssrf/ssrf16.png)
...
![lab2 solved](../../../assets/images/portswigger/ssrf/ssrf17.png)

---

*SSRF With Blacklist-Based Input Filter* 

![lab3 intro](../../../assets/images/portswigger/ssrf/ssrf18.png)
...
![workflow](../../../assets/images/portswigger/ssrf/ssrf19.png)
...
![repeater error](../../../assets/images/portswigger/ssrf/ssrf20.png)
...
![double url encode admin](../../../assets/images/portswigger/ssrf/ssrf21.png)
...
![200 response](../../../assets/images/portswigger/ssrf/ssrf22.png)


![shown in browser](../../../assets/images/portswigger/ssrf/ssrf23.png)
...
![can't delete](../../../assets/images/portswigger/ssrf/ssrf24.png)
...
![request to real endpoint](../../../assets/images/portswigger/ssrf/ssrf25.png)

![lab3 solved](../../../assets/images/portswigger/ssrf/ssrf26.png)

---

*SSRF With Whitelist-Based Input Filter* 

![lab4 intro](../../../assets/images/portswigger/ssrf/ssrf27.png)
...
![workflow](../../../assets/images/portswigger/ssrf/ssrf28.png)
...
![white listed url](../../../assets/images/portswigger/ssrf/ssrf29.png)
...
![500 internal server error](../../../assets/images/portswigger/ssrf/ssrf30.png)
...
![400 bad request](../../../assets/images/portswigger/ssrf/ssrf31.png)
...
![double url encode hash](../../../assets/images/portswigger/ssrf/ssrf32.png)
...
![admin panel](../../../assets/images/portswigger/ssrf/ssrf33.png)

![shown in browser](../../../assets/images/portswigger/ssrf/ssrf34.png)
...
![loopback only](../../../assets/images/portswigger/ssrf/ssrf35.png)
...
![302 redirect](../../../assets/images/portswigger/ssrf/ssrf36.png)
...
![lab4 solved](../../../assets/images/portswigger/ssrf/ssrf37.png)

---

*SSRF With Filter Bypass Via Open Redirection Vulnerability*

![lab5 intro](../../../assets/images/portswigger/ssrf/ssrf38.png)

Once again I started this lab off by utilizing the stock check feature within the UI and observed the workflow. 

![workflow](../../../assets/images/portswigger/ssrf/ssrf39.png)
...
![can't manipulate stockapi](../../../assets/images/portswigger/ssrf/ssrf40.png)
...
![path parameter](../../../assets/images/portswigger/ssrf/ssrf41.png)
...
![200 ok](../../../assets/images/portswigger/ssrf/ssrf44.png)

![admin panel](../../../assets/images/portswigger/ssrf/ssrf45.png)
...
![can't delete](../../../assets/images/portswigger/ssrf/ssrf46.png)
...
![200 ok](../../../assets/images/portswigger/ssrf/ssrf47.png)

![lab5 solved](../../../assets/images/portswigger/ssrf/ssrf48.png)
