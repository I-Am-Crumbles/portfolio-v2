...
![challenge1](../../../assets/images/owasp-webgoat/injection/inject01.png)

![challenge 1 cont](../../../assets/images/owasp-webgoat/injection/inject02.png)

`SELECT department FROM employees WHERE first_name='Bob' `

![Complete1](../../../assets/images/owasp-webgoat/injection/inject03.png)

**Challenge 2**

*Data Manipulation Language*

![challenge2](../../../assets/images/owasp-webgoat/injection/inject04.png)

`UPDATE employees SET department='Sales' WHERE first_name='Tobi' `


![complete3](../../../assets/images/owasp-webgoat/injection/inject05.png)

**Challenge 3**

*Data Definition Language*

![challenge3](../../../assets/images/owasp-webgoat/injection/inject06.png)

`ALTER TABLE employees ADD phone varchar(20)`

![complete3](../../../assets/images/owasp-webgoat/injection/inject07.png)

**Challenge 4**

*Data Control Language*

![challenge4](../../../assets/images/owasp-webgoat/injection/inject08.png)

`GRANT SELECT, INSERT, UPDATE, DELETE ON grant_rights TO unauthorized_user; `

![complete4](../../../assets/images/owasp-webgoat/injection/inject09.png)

**Challenge 5**

*String SQL INjection*

![challenge5](../../../assets/images/owasp-webgoat/injection/inject10.png)
...
![challenge6](../../../assets/images/owasp-webgoat/injection/inject11.png)
...
![challenge7](../../../assets/images/owasp-webgoat/injection/inject12.png)
...
![challenge8](../../../assets/images/owasp-webgoat/injection/inject13.png)
...
![challenge9](../../../assets/images/owasp-webgoat/injection/inject14.png)
...
![challenge10](../../../assets/images/owasp-webgoat/injection/inject15.png)
...
![challenge1](../../../assets/images/owasp-webgoat/injection/inject16.png)
...
![upload](../../../assets/images/owasp-webgoat/injection/inject17.png)
...
![request1](../../../assets/images/owasp-webgoat/injection/inject18.png)
...
![edit request](../../../assets/images/owasp-webgoat/injection/inject19.png)

![congrats](../../../assets/images/owasp-webgoat/injection/inject20.png)

**Challenge 2**

*Path Traversal While Uploading Files Continued*

![challenge2](../../../assets/images/owasp-webgoat/injection/inject21.png)
...
![request2](../../../assets/images/owasp-webgoat/injection/inject22.png)

Experimenting a little I'm able to learn that the fullname parameter will drop a leading `../` and `/`, but not a leading `.` or `..`.

![edit1](../../../assets/images/owasp-webgoat/injection/inject23.png)

![edit2](../../../assets/images/owasp-webgoat/injection/inject24.png)

![edit3](../../../assets/images/owasp-webgoat/injection/inject25.png)
...
![complete2](../../../assets/images/owasp-webgoat/injection/inject26.png)
...
![challenge3](../../../assets/images/owasp-webgoat/injection/inject27.png)
...
![request3](../../../assets/images/owasp-webgoat/injection/inject28.png)
...
![filename](../../../assets/images/owasp-webgoat/injection/inject29.png)

![complete3](../../../assets/images/owasp-webgoat/injection/inject30.png)
...
![challenge1](../../../assets/images/owasp-webgoat/injection/inject31.png)
...
![console1](../../../assets/images/owasp-webgoat/injection/inject32.png)

![console2](../../../assets/images/owasp-webgoat/injection/inject33.png)

Since the cookies are the same on each tab I complete the challenge manually. 

![complete1](../../../assets/images/owasp-webgoat/injection/inject34.png)

**Challenge 2**

*Reflected XSS*

![challenge2](../../../assets/images/owasp-webgoat/injection/inject35.png)

I start off this challenge by clicking the Purchase button at the bottom of the page and seeing what happens. 

![purchase](../../../assets/images/owasp-webgoat/injection/inject36.png)
...
![complete2](../../../assets/images/owasp-webgoat/injection/inject37.png)

**Challenge 3**

*DOM-Based XSS*

![challenge3](../../../assets/images/owasp-webgoat/injection/inject38.png)
...
![debugger](../../../assets/images/owasp-webgoat/injection/inject39.png)
...
![complete3](../../../assets/images/owasp-webgoat/injection/inject40.png)

**Challenge 4**

*DOM-BASED XSS Continued*

![challenge4](../../../assets/images/owasp-webgoat/injection/inject41.png)
...
![url](../../../assets/images/owasp-webgoat/injection/inject42.png)
...
![insert script](../../../assets/images/owasp-webgoat/injection/inject43.png)

*1077798770* 

![complete4](../../../assets/images/owasp-webgoat/injection/inject44.png)
