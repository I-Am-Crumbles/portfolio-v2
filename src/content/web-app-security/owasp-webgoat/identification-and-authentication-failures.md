...
![Challenge1](../../../assets/images/owasp-webgoat/authfailures/auth01.png)
...
![load Burp](../../../assets/images/owasp-webgoat/authfailures/auth02.png)

Then I navigate over to the webpage in Burp Suites web browser and turn intercept on so that I can capture the request. 

![Page in Burp](../../../assets/images/owasp-webgoat/authfailures/auth03.png)

![burp request](../../../assets/images/owasp-webgoat/authfailures/auth04.png)
...
![edit request](../../../assets/images/owasp-webgoat/authfailures/auth05.png)

![edit failed](../../../assets/images/owasp-webgoat/authfailures/auth06.png)
...
![rename params](../../../assets/images/owasp-webgoat/authfailures/auth07.png)
...
![complete](../../../assets/images/owasp-webgoat/authfailures/auth08.png)
---
...
![Challenge2](../../../assets/images/owasp-webgoat/authfailures/auth09.png)
...
![Inspect 1](../../../assets/images/owasp-webgoat/authfailures/auth10.png)

![Inspect 2](../../../assets/images/owasp-webgoat/authfailures/auth11.png)
...
![creds](../../../assets/images/owasp-webgoat/authfailures/auth12.png)

Logging in with them satisfies the requirements of the challenge. 

![complete 2](../../../assets/images/owasp-webgoat/authfailures/auth13.png)
---
...
![challenge 3](../../../assets/images/owasp-webgoat/authfailures/auth14.png)
...
![username](../../../assets/images/owasp-webgoat/authfailures/auth15.png)

![complete3](../../../assets/images/owasp-webgoat/authfailures/auth16.png)
---
...
![challenge 4](../../../assets/images/owasp-webgoat/authfailures/auth17.png)
...
![vote totals](../../../assets/images/owasp-webgoat/authfailures/auth18.png)
...
![token](../../../assets/images/owasp-webgoat/authfailures/auth19.png)
...
![cyberchef](../../../assets/images/owasp-webgoat/authfailures/auth20.png)
...
![swap](../../../assets/images/owasp-webgoat/authfailures/auth21.png)
...
![burp request](../../../assets/images/owasp-webgoat/authfailures/auth22.png)
...
![complete4](../../../assets/images/owasp-webgoat/authfailures/auth23.png)
---
...
![Questions](../../../assets/images/owasp-webgoat/authfailures/auth24.png)
...
![complete5](../../../assets/images/owasp-webgoat/authfailures/auth25.png)
---
...
![challenge 6](../../../assets/images/owasp-webgoat/authfailures/auth26.png)
...
![john](../../../assets/images/owasp-webgoat/authfailures/auth27.png)
...
![token](../../../assets/images/owasp-webgoat/authfailures/auth28.png)

![complete6](../../../assets/images/owasp-webgoat/authfailures/auth29.png)
---
...
![challenge7](../../../assets/images/owasp-webgoat/authfailures/auth30.png)

If I open the link to the log file I'm greeted with a page that contains an expired JWT token. 

![logged token](../../../assets/images/owasp-webgoat/authfailures/auth31.png)
...
![decode token](../../../assets/images/owasp-webgoat/authfailures/auth32.png)
...
![burp request](../../../assets/images/owasp-webgoat/authfailures/auth33.png)
...
![decode](../../../assets/images/owasp-webgoat/authfailures/auth34.png)
...
![encode](../../../assets/images/owasp-webgoat/authfailures/auth35.png)
...
![logged token](../../../assets/images/owasp-webgoat/authfailures/auth36.png)
...
![logged token](../../../assets/images/owasp-webgoat/authfailures/auth37.png)

![complete 7](../../../assets/images/owasp-webgoat/authfailures/auth38.png)
---
