...
![Challenge1](../../../assets/images/owasp-webgoat/ssrf/csrf01.png)
...
![Click button](../../../assets/images/owasp-webgoat/ssrf/csrf02.png)
...
![Request](../../../assets/images/owasp-webgoat/ssrf/csrf03.png)
...
![curl post](../../../assets/images/owasp-webgoat/ssrf/csrf04.png)

It worked. The website sends me back a flag and a message congratulating me on passing the challenge. 

![flag1](../../../assets/images/owasp-webgoat/ssrf/csrf05.png)
---
**WebGoat CSRF Challenge 2**

![challenge 2](../../../assets/images/owasp-webgoat/ssrf/csrf06.png)
...
![submit comment](../../../assets/images/owasp-webgoat/ssrf/csrf07.png)
...
![inspect request](../../../assets/images/owasp-webgoat/ssrf/csrf08.png)

If I click the *Request* tab I can see the actual content that was sent.

![request content](../../../assets/images/owasp-webgoat/ssrf/csrf09.png)
...
![curl success](../../../assets/images/owasp-webgoat/ssrf/csrf10.png)

There was no flag to Receive this time. But my review was posted to the site.

![comment posted](../../../assets/images/owasp-webgoat/ssrf/csrf11.png)
---
**WebGoat CSRF Challenge 3**

![Challenge 3](../../../assets/images/owasp-webgoat/ssrf/csrf12.png)
...
![http response header](../../../assets/images/owasp-webgoat/ssrf/csrf13.png)
...
![curl challenge 3](../../../assets/images/owasp-webgoat/ssrf/csrf14.png)

![challenge 3 flag](../../../assets/images/owasp-webgoat/ssrf/csrf15.png)
...
![ssrf1](../../../assets/images/owasp-webgoat/ssrf/csrf16.png)
...
![inspect button](../../../assets/images/owasp-webgoat/ssrf/csrf17.png)
...
![edit hidden value](../../../assets/images/owasp-webgoat/ssrf/csrf18.png)

![Complete](../../../assets/images/owasp-webgoat/ssrf/csrf19.png)
...
![request payload](../../../assets/images/owasp-webgoat/ssrf/csrf20.png)

![Curl request ssrf](../../../assets/images/owasp-webgoat/ssrf/csrf21.png)
---
**WebGoat SSRF Challenge 2**

The second SSRF challenge is pretty much the exact same as the previous one. 

![ssrf challenge 2](../../../assets/images/owasp-webgoat/ssrf/csrf22.png)

If I inspect the *Try This* button I find a hidden value set to *images/cat.png*.  

![inspect button](../../../assets/images/owasp-webgoat/ssrf/csrf23.png)
...
![edit inspect page](../../../assets/images/owasp-webgoat/ssrf/csrf24.png)

![challenge complete](../../../assets/images/owasp-webgoat/ssrf/csrf25.png)
...
![with curl again](../../../assets/images/owasp-webgoat/ssrf/csrf26.png)
