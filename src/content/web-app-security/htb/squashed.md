...
![infocard](../../../assets/images/htb/squashed/Squashed.png)
...
![nmap output](../../../assets/images/htb/squashed/squashed01.png)
...
![whatweb output](../../../assets/images/htb/squashed/squashed02.png)
...
![enumerate shares](../../../assets/images/htb/squashed/squashed06.png)
...
![make directories](../../../assets/images/htb/squashed/squashed07.png)

![mount the share](../../../assets/images/htb/squashed/squashed08.png)

![enumerate through the shares](../../../assets/images/htb/squashed/squashed09.png)
...
![mount the share](../../../assets/images/htb/squashed/squashed10.png)
...
![create new user](../../../assets/images/htb/squashed/squashed11.png)
...
![imposter owner](../../../assets/images/htb/squashed/squashed12.png)
...
![locate](../../../assets/images/htb/squashed/squashed13.png)

![copy file](../../../assets/images/htb/squashed/squashed14.png)
...
![vim](../../../assets/images/htb/squashed/squashed15.png)

![netcat](../../../assets/images/htb/squashed/squashed16.png)
...
![copy payload](../../../assets/images/htb/squashed/squashed17.png)

![firefox](../../../assets/images/htb/squashed/squashed18.png)
...
![whoami](../../../assets/images/htb/squashed/squashed19.png)

`python3 -c 'import pty; pty.spawn("/bin/bash")'`

![user flag](../../../assets/images/htb/squashed/squashed20.png)
...
![.Xauthority](../../../assets/images/htb/squashed/squashed21.png)
...
![cookie](../../../assets/images/htb/squashed/squashed22.png)
...
![copy cookie](../../../assets/images/htb/squashed/squashed23.png)

`python3 -m htt.server 80`

![python http server](../../../assets/images/htb/squashed/squashed24.png)

`curl http://host_ip/.Xauthority -o /tmp/.Xauthority` < This is done from the terminal acting as *alex*.

![curl](../../../assets/images/htb/squashed/squashed25.png)
...
![export](../../../assets/images/htb/squashed/squashed26.png)
...
![man pages](../../../assets/images/htb/squashed/squashed27.png)

`xwd -help`

![help pages](../../../assets/images/htb/squashed/squashed28.png)
...
![xwd](../../../assets/images/htb/squashed/squashed29.png)
...
![serve it up 2](../../../assets/images/htb/squashed/squashed30.png)
...
![convert](../../../assets/images/htb/squashed/squashed31.png)

![open image](../../../assets/images/htb/squashed/squashed32.png)
...
![plaintext password](../../../assets/images/htb/squashed/squashed33.png)

![switch user](../../../assets/images/htb/squashed/squashed34.png)

![root flag](../../../assets/images/htb/squashed/squashed35.png)

![pwned](../../../assets/images/htb/squashed/squashed36.png)
